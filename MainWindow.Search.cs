...
public sealed partial class MainWindow : Window
{
    ...
    private void PopulateSearchRegistry()
    {
        _searchRegistry = new List<SearchItem>
        {
            ...
            new SearchItem { Title = "Startup & Services".T(), Description = "Manage background daemons, startup impact scores, boot speed acceleration.".T(), PageTag = "Startup", Keywords = "startup boot services background apps speed up khoi dong dich vu tang toc mo may", IconGlyph = "\uE7B5" },
