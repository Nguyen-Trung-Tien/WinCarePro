...
public sealed partial class MainWindow : Window
{
    ...
    private void PopulateSearchRegistry()
    {
        _searchRegistry = new List<SearchItem>
        {
            ...
            new SearchItem { Title = "Settings: Feature Guide & Manual".T(), Description = "Comprehensive step-by-step visual handbook and safety guidelines for all 15 modules.".T(), PageTag = "Settings:10", Keywords = "user guide manual huong dan su dung handbook document so tay huong dan chi tiet", IconGlyph = "\uE897" }
        };
    }
