...
public partial class TranslationManager
{
    private void InitializeTranslations()
    {
        ...
        _translations["AI WinCare Engine"] = "AI WinCare Engine";
        _translations["⚡ System Turbo Mode"] = "⚡ Tăng tốc hệ thống";
        _translations["WinCare AI Assistant"] = "Trợ lý AI WinCare";
        _translations["System Optimizer"] = "Tối ưu hệ thống";
        _translations["Widget HUD"] = "Widget HUD";
        _translations["User Guide & Documentation"] = "Hướng Dẫn Sử Dụng & Tài Liệu";
        _translations["User Guide &amp; Documentation"] = "Hướng Dẫn Sử Dụng & Tài Liệu";
        _translations["User Guide"] = "Hướng Dẫn Sử Dụng";
        ...
        _translations["Real-time hardware telemetry & intelligent system care."] = "Giám sát phần cứng thời gian thực & chăm sóc hệ thống thông minh.";
        _translations["Real-time hardware telemetry &amp; intelligent system care."] = "Giám sát phần cứng thời gian thực & chăm sóc hệ thống thông minh.";
        _translations["Intelligent diagnostics & automated optimization."] = "Chẩn đoán thông minh & tối ưu tự động.";
        _translations["Intelligent multi-factor diagnostics & system health recommendations."] = "Chẩn đoán thông minh đa yếu tố & đề xuất sức khỏe hệ thống.";
        _translations["Intelligent multi-factor diagnostics &amp; system health recommendations."] = "Chẩn đoán thông minh đa yếu tố & đề xuất sức khỏe hệ thống.";
        _translations["Intelligent multi-factor system diagnostics and automated remedies."] = "Chẩn đoán thông minh đa yếu tố và khắc phục tự động.";
        _translations["Smart Diagnostics Engine"] = "Động cơ chẩn đoán thông minh";
        _translations["System Health Core"] = "Lõi sức khỏe hệ thống";
        _translations["Purge system caches, temp files & debris."] = "Dọn dẹp bộ nhớ đệm & tệp rác hệ thống.";
        _translations["Purge system caches, temp files &amp; debris."] = "Dọn dẹp bộ nhớ đệm & tệp rác hệ thống.";
        _translations["Cleanly uninstall apps & remove leftover data."] = "Gỡ cài đặt sạch sẽ & loại bỏ tệp thừa.";
        _translations["Cleanly uninstall apps &amp; remove leftover data."] = "Gỡ cài đặt sạch sẽ & loại bỏ tệp thừa.";
        _translations["Network telemetry, DNS speed & TCP/IP repairs."] = "Tối ưu mạng, tốc độ DNS & sửa kết nối.";
        _translations["Network telemetry, DNS speed &amp; TCP/IP repairs."] = "Tối ưu mạng, tốc độ DNS & sửa kết nối.";
        _translations["SFC integrity, DISM & core Windows services."] = "Kiểm tra toàn vẹn SFC, DISM & dịch vụ.";
        _translations["SFC integrity, DISM &amp; core Windows services."] = "Kiểm tra toàn vẹn SFC, DISM & dịch vụ.";
        _translations["Hardware trust, credential safety & privacy."] = "Bảo vệ phần cứng, dữ liệu & quyền riêng tư.";
        _translations["Hardware trust, credential safety &amp; privacy."] = "Bảo vệ phần cứng, dữ liệu & quyền riêng tư.";
        _translations["Kernel tuning, process scheduling & memory caching."] = "Tinh chỉnh hệ thống, tiến trình & bộ nhớ.";
        _translations["Kernel tuning, process scheduling &amp; memory caching."] = "Tinh chỉnh hệ thống, tiến trình & bộ nhớ.";
        _translations["Prioritize CPU threads & minimize latency."] = "Tối ưu luồng CPU & giảm thiểu độ trễ.";
        _translations["Manage shell extensions and declutter right-click menus."] = "Quản lý tiện ích & làm gọn menu chuột phải.";
        _translations["Control startup apps & boot velocity."] = "Quản lý khởi động & tăng tốc mở máy.";
        _translations["Control startup apps &amp; boot velocity."] = "Quản lý khởi động & tăng tốc mở máy.";
        _translations["S.M.A.R.T telemetry, storage & duplicate finder."] = "Sức khỏe ổ đĩa, dung lượng & tệp trùng.";
        _translations["S.M.A.R.T telemetry, storage &amp; duplicate finder."] = "Sức khỏe ổ đĩa, dung lượng & tệp trùng.";
        _translations["Invalid registry entries, repairs & backups."] = "Sửa lỗi registry, dọn dẹp & sao lưu.";
        _translations["Invalid registry entries, repairs &amp; backups."] = "Sửa lỗi registry, dọn dẹp & sao lưu.";
        _translations["Apps & packages updates via WinGet."] = "Cập nhật ứng dụng & phần mềm qua WinGet.";
        _translations["Apps &amp; packages updates via WinGet."] = "Cập nhật ứng dụng & phần mềm qua WinGet.";
        _translations["System telemetry alerts, diagnostic logs & operation records."] = "Cảnh báo hệ thống, nhật ký & lịch sử.";
        _translations["System telemetry alerts, diagnostic logs &amp; operation records."] = "Cảnh báo hệ thống, nhật ký & lịch sử.";
        _translations["Personalize preferences, language & updates."] = "Cá nhân hóa tùy chọn, ngôn ngữ & hệ thống.";
        _translations["Configure personal preferences, background behavior, system logging, and themes."] = "Cấu hình tùy chọn cá nhân, hành vi chạy nền và giao diện.";
        _translations["Neural Core Engine"] = "Lõi AI Thông Minh";
        _translations["Export AI Report"] = "Xuất báo cáo AI";
        _translations["Export Report"] = "Xuất báo cáo";
        _translations["Export diagnostic report to file"] = "Xuất báo cáo chẩn đoán ra tệp";
        _translations["Execute all safe optimization fixes in one click"] = "Thực hiện tất cả tối ưu an toàn chỉ với 1-click";
        _translations["Trigger a deep neural diagnostics scan"] = "Kích hoạt quét chẩn đoán chuyên sâu AI";
        _translations["Run AI Diagnostics"] = "Quét chẩn đoán AI";
        _translations["1-Click Smart Remedy"] = "1-Click Tối ưu tự động";
        _translations["Remediating All..."] = "Đang tối ưu tất cả...";
        _translations["Scanning AI Diagnostics..."] = "Đang quét chẩn đoán AI...";
        _translations["AI Recommended Optimizations"] = "Đề xuất tối ưu từ AI";
        _translations["AI SCORE"] = "ĐIỂM AI";
        _translations["AI Score"] = "Điểm AI";
        _translations["Optimal Health"] = "Sức khỏe tối ưu";
        _translations["Status: Optimal Health"] = "Trạng thái: Sức khỏe tối ưu";
        _translations["WinCare AI Assistant predicts maximum system stability with 0 critical bottlenecks detected."] = "Trợ lý AI WinCare dự báo hệ thống đạt độ ổn định tối đa, không phát hiện điểm nghẽn nghiêm trọng.";
        _translations["Neural Scan: Active & Up to date"] = "Quét AI: Đang hoạt động & Đã cập nhật";
        _translations["Neural Scan: Active &amp; Up to date"] = "Quét AI: Đang hoạt động & Đã cập nhật";
        _translations["Storage Horizon"] = "Dung lượng dự kiến";
        _translations["30+ Days Free"] = "> 30 Ngày an toàn";
        _translations["Boot Optimization"] = "Tăng tốc mở máy";
        _translations["Memory Index"] = "Chỉ số bộ nhớ";
        _translations["Stability Vector"] = "Độ ổn định";
        _translations["Drive C: exhaustion forecast"] = "Dự báo đầy ổ đĩa C:";
        _translations["Potential startup shaving"] = "Tiềm năng rút ngắn mở máy";
        _translations["Working set & Standby state"] = "Trạng thái bộ nhớ và Standby";
        _translations["Zero crash anomalies"] = "Không phát hiện lỗi xung đột";
        _translations["AI Actions:"] = "Tác vụ AI:";
        _translations["AI Automated Quick Remedies"] = "Tác vụ khắc phục nhanh từ AI";
        _translations["Instant single-click kernel optimizations & resource purge"] = "Tối ưu hệ thống & giải phóng tài nguyên tức thì";
        _translations["Instant single-click kernel optimizations &amp; resource purge"] = "Tối ưu hệ thống & giải phóng tài nguyên tức thì";
        _translations["Engine Ready"] = "Sẵn sàng hoạt động";
        _translations["Purge RAM Cache"] = "Giải phóng RAM";
        _translations["Free Working Set"] = "Xóa bộ đệm RAM";
        _translations["Clean Temp Junk"] = "Dọn tệp rác";
        _translations["Purge Cache & Debris"] = "Xóa tệp tạm & rác";
        _translations["Purge Cache &amp; Debris"] = "Xóa tệp tạm & rác";
        _translations["Optimize Startup Apps"] = "Tối ưu khởi động";
        _translations["Trim Boot Overhead"] = "Rút ngắn mở máy";
        _translations["Flush DNS & Winsock"] = "Xóa cache DNS";
        _translations["Flush DNS &amp; Winsock"] = "Xóa cache DNS";
        _translations["Repair Socket Cache"] = "Sửa kết nối socket";
        _translations["No System Bottlenecks Detected"] = "Không phát hiện điểm nghẽn hệ thống";
        _translations["Your system is running at optimal peak performance. AI Assistant is continuously monitoring telemetry in the background."] = "Hệ thống đang hoạt động tối ưu. Trợ lý AI đang liên tục giám sát tài nguyên.";
        _translations["Status: Optimal Health"] = "Trạng thái: Tối ưu";
        _translations["Status: Fair Condition"] = "Trạng thái: Khá";
        _translations["Status: Maintenance Required"] = "Trạng thái: Cần bảo trì";
        _translations["AI Active"] = "AI Hoạt Động";
        _translations["Apply Fix"] = "Khắc phục";
        _translations["Applying Fix..."] = "Đang khắc phục...";
        _translations["30+ Days Free"] = "> 30 Ngày";
        _translations["-1.5s Boot Time"] = "-1.5s Mở máy";
        _translations["Stable"] = "Ổn định";
        _translations["99.9% Optimal"] = "99.9% Tối ưu";
        _translations["ENABLE TURBO NOW"] = "BẬT TURBO";
        _translations["DISABLE TURBO"] = "TẮT TURBO";
        _translations["BẬT TURBO NOW"] = "BẬT TURBO";
        _translations["TẮT TURBO"] = "TẮT TURBO";
        _translations["Gaming Turbo 2.0 Mode"] = "Chế độ Gaming Turbo";
        _translations["Optimize physical RAM Working Set & release CPU resources during gaming."] = "Giải phóng RAM và ưu tiên CPU khi chơi Game.";
        _translations["Ready to boost! Click the button to release system resources."] = "Sẵn sàng tăng tốc! Bấm nút để giải phóng tài nguyên.";
        ...
        _translations["Gaming Turbo mode is OFF. Ready to boost!"] = "Gaming Turbo đang tắt. Sẵn sàng tăng tốc!";
        _translations["⚡ Gaming Turbo ENABLED! Cleaning memory & optimizing CPU priority..."] = "⚡ Đã bật Gaming Turbo! Đang dọn RAM & ưu tiên CPU...";
        _translations["🚀 Gaming Turbo ACTIVE! Freed {0:N0} MB RAM across {1} processes."] = "🚀 Gaming Turbo đang bật! Đã giải phóng {0:N0} MB RAM.";
        _translations["Gaming Turbo mode is OFF. System restored to standard state."] = "Gaming Turbo đã tắt. Hệ thống ở trạng thái bình thường.";
        _translations["Automated diagnostics via WinCare AI Assistant & System Turbo mode."] = "Chẩn đoán thông minh bằng Trợ lý AI và Tối ưu hệ thống.";
        ...
        _translations["System Dashboard"] = "Bảng điều khiển";
        _translations["Real-time performance monitors, PC diagnostics diagnostics, and speed optimizer."] = "Giám sát hiệu năng và chẩn đoán tăng tốc PC.";
        _translations["System Health Overview"] = "Sức khỏe hệ thống";
        _translations["Health Score"] = "Điểm sức khỏe";
        _translations["A scan verifies diagnostic alerts, junk file volumes, startup overhead, and available security fixes. Optimize now to clean garbage files and improve loading speeds."] = "Quét phát hiện tệp rác, tiến trình thừa và lỗi bảo mật. Tối ưu ngay để tăng tốc máy tính.";
        _translations["Scan System"] = "Quét hệ thống";
        _translations["Optimize Now"] = "Tối ưu ngay";
        _translations["CPU Processor Load"] = "Tải lượng CPU";
        _translations["Memory (RAM) Footprint"] = "Bộ nhớ RAM";
        _translations["Graphics Card (GPU) Load"] = "Tải lượng GPU";
        _translations["System Disk Activity"] = "Hoạt động ổ đĩa";
        _translations["Smart AI Advice"] = "Đề xuất AI";
        _translations["Suggested actions based on scanning diagnostics:"] = "Đề xuất tối ưu hệ thống:";
        _translations["No recommendations. Run a full scan to evaluate your PC health."] = "Không có đề xuất. Hãy chạy quét để kiểm tra sức khỏe PC.";
        _translations["Diagnostics Discoveries"] = "Phát hiện chẩn đoán";
        _translations["Export Report"] = "Xuất báo cáo";
        _translations["Category"] = "Danh mục";
        _translations["Check Name"] = "Kiểm tra";
        _translations["Description"] = "Mô tả";
        _translations["Status"] = "Trạng thái";
        _translations["Operations & Optimization Timeline"] = "Lịch sử hoạt động & Tối ưu";
        _translations["Operations &amp; Optimization Timeline"] = "Lịch sử hoạt động & Tối ưu";
        _translations["Operations & Activity Log"] = "Lịch sử & Nhật ký hoạt động";
        _translations["Advanced Details & History Log"] = "Chi tiết & Lịch sử hoạt động";
        _translations["Advanced Details &amp; History Log"] = "Chi tiết & Lịch sử hoạt động";
        _translations["System Deep Layer Diagnostics"] = "Chẩn đoán chuyên sâu hệ thống";
        _translations["Detailed audits, itemized discoveries & operation logs"] = "Báo cáo chi tiết phát hiện & nhật ký hoạt động";
        _translations["Detailed audits, itemized discoveries &amp; operation logs"] = "Báo cáo chi tiết phát hiện & nhật ký hoạt động";
        _translations["Fix Now"] = "Khắc phục";
        _translations["PASSED"] = "ĐẠT";
        _translations["ATTENTION"] = "CẦN XỬ LÝ";
        _translations["Success"] = "Thành công";
        _translations["Failed"] = "Thất bại";
        _translations["Warning"] = "Cảnh báo";
        _translations["Info"] = "Thông tin";
        _translations["System"] = "Hệ thống";
        _translations["Test Module"] = "Mô-đun kiểm thử";
        _translations["TestModule"] = "Mô-đun kiểm thử";
        _translations["Performance Trend History"] = "Lịch sử xu hướng hiệu năng";
        _translations["Rolling history of resource load levels (CPU, RAM, GPU, Disk)"] = "Biểu đồ tải tài nguyên theo thời gian (CPU, RAM, GPU, Ổ đĩa)";
        _translations["Bottleneck Detection"] = "Phát hiện nghẽn cổ chai";
        _translations["Weighted analysis of CPU, RAM and Disk constraints."] = "Phân tích tải trọng CPU, RAM và giới hạn Ổ đĩa.";
        _translations["Active Monitoring"] = "Đang giám sát";
        _translations["Uptime"] = "Thời gian bật";
        _translations["Network"] = "Mạng";
        _translations["Junk Size"] = "Dung lượng rác";
        _translations["Apps"] = "Ứng dụng";
        _translations["System Status: Idle"] = "Trạng thái: Sẵn sàng";
        ...
        _translations["Status: Evaluating Connection and Security Status..."] = "Trạng thái: Đang kiểm tra kết nối & bảo mật...";
        _translations["Status: Calculating System Health Index..."] = "Trạng thái: Đang tính điểm sức khỏe hệ thống...";
        _translations["Ready to scan system"] = "Sẵn sàng quét hệ thống";
        _translations["Status: Optimizing - Cleaning Junk Files..."] = "Trạng thái: Đang dọn tệp rác...";
        _translations["Status: Optimizing - Cleaning Windows Update Cache..."] = "Trạng thái: Đang dọn cache Windows Update...";
        _translations["Status: Optimizing - Repairing Registry Issues..."] = "Trạng thái: Đang sửa lỗi Registry...";
        _translations["Status: Optimizing - Performing Active RAM Boost..."] = "Trạng thái: Đang giải phóng bộ nhớ RAM...";
        _translations["Status: Optimizing - Flushing DNS Resolver Cache..."] = "Trạng thái: Đang xóa bộ nhớ đệm DNS...";
        _translations["Status: Optimizing - Applying Speed & UI Tweaks..."] = "Trạng thái: Đang áp dụng tinh chỉnh tăng tốc...";
        _translations["Optimization Complete! System is fully optimized."] = "Tối ưu hoàn tất! Hệ thống đang hoạt động tối ưu.";
        _translations["PC Health Secured (RAM Boosted, Junk Cleaned)"] = "PC Hoạt Động Tốt (Đã tối ưu RAM & dọn rác)";
        _translations["Restart is recommended to fully apply system tweaks."] = "Khuyến nghị khởi động lại để áp dụng đầy đủ tinh chỉnh.";
        ...
        _translations["Healthy"] = "Tốt";
        _translations["Action Required"] = "Cần xử lý";

        // --- Junk Cleaner Page ---
        _translations["Current Junk:"] = "Tệp rác phát hiện:";
        _translations["Safe cleanup files. Empty the recycle bin, Windows installers cache, and directx shaders."] = "Dọn sạch tệp tạm, thùng rác và bộ nhớ đệm an toàn.";
        ...
        _translations["Live Operations Trace"] = "Nhật ký hoạt động";
        _translations["Ready to scan junk files"] = "Sẵn sàng quét tệp rác";
        _translations["Scan completed. Select items to clean."] = "Quét hoàn tất. Chọn mục cần dọn dẹp.";
        _translations["Scanning directories..."] = "Đang quét thư mục...";
        _translations["Cleaning selected directories..."] = "Đang dọn dẹp thư mục đã chọn...";
        _translations["Cleanup complete. Reclaimed"] = "Dọn dẹp hoàn tất. Đã giải phóng";
        _translations["Windows Temp Files"] = "Tệp tạm Windows";
        _translations["Temporary files generated by the Windows OS operating system."] = "Tệp tạm sinh ra trong quá trình Windows hoạt động.";
        _translations["User Temp Files"] = "Tệp tạm người dùng";
        _translations["Local application cache files and user account temp data."] = "Dữ liệu tạm của các ứng dụng người dùng.";
        _translations["Browser Cache"] = "Bộ nhớ đệm trình duyệt";
        _translations["Cached webpages, images, and offline resources from Microsoft Edge."] = "Bộ nhớ đệm web và hình ảnh trình duyệt.";
        _translations["System Log Files"] = "Tệp nhật ký hệ thống";
        _translations["Diagnostic logging traces and Windows event log reports."] = "Nhật ký sự kiện và lỗi hệ thống.";
        _translations["Recycle Bin"] = "Thùng rác";
        _translations["Deleted files stored in your Recycle Bin."] = "Tệp đã xóa trong Thùng rác.";
        _translations["Update Installer Cache"] = "Bộ nhớ đệm cập nhật";
        _translations["Leftover software update components and cached windows setup files."] = "Tệp cài đặt và cập nhật Windows còn dư.";
        _translations["DirectX Shader Cache"] = "Bộ nhớ đệm DirectX Shader";
        _translations["Graphics driver compiled shaders cache for speeding up UI renders."] = "Bộ nhớ đệm đồ họa DirectX.";
        _translations["Thumbnail Cache"] = "Bộ nhớ đệm ảnh thu nhỏ";
        _translations["Cached preview image files of system explorer folders."] = "Bộ nhớ đệm hình thu nhỏ của thư mục.";
        
        // v3.2 Junk Redesign additions
        _translations["Delivery Optimization Files"] = "Tệp Delivery Optimization";
        _translations["Cache files used for downloading and sharing Windows updates."] = "Bộ nhớ đệm tải và chia sẻ cập nhật Windows.";
        _translations["System Prefetch Files"] = "Tệp Prefetch hệ thống";
        _translations["System prefetch cache files created to speed up application startup."] = "Tệp đệm tăng tốc khởi động ứng dụng.";
        _translations["System Crash Dumps"] = "Tệp kết xuất sự cố";
        _translations["Memory dump files and log traces created when system crash or error occurs."] = "Tệp kết xuất bộ nhớ khi máy tính bị lỗi hoặc sập nguồn.";
        _translations["Developer & IDE Caches"] = "Bộ nhớ đệm Lập trình & IDE";
        _translations["Cached build artifacts, package manager caches (npm, pip, NuGet, VS Code)."] = "Bộ nhớ đệm npm, pip, NuGet, VS Code...";
        _translations["Top Largest Files"] = "Tệp dung lượng lớn nhất";
        ...
        _translations["Select a category to view its top files details."] = "Chọn danh mục để xem chi tiết tệp lớn nhất.";
        _translations["Scan system to find junk files."] = "Hãy quét hệ thống để tìm tệp rác.";
        ...
        // --- Network Center Page ---
        _translations["Network Center"] = "Trung tâm mạng";
        _translations["Baud rate network parameters, active TCP ports monitoring, and DNS optimizer."] = "Kiểm tra tốc độ mạng, cổng kết nối và tối ưu DNS.";
        _translations["Active Adapter Specs"] = "Thông số mạng";
        _translations["Speed & Bandwidth Test"] = "Kiểm tra tốc độ mạng";
        _translations["Active TCP Port Listeners"] = "Cổng mạng TCP đang mở";
        _translations["DNS Resolver Settings"] = "Cài đặt DNS";
        _translations["Adapter Name:"] = "Card mạng:";
        _translations["Connection Type:"] = "Kết nối:";
        _translations["MAC Address:"] = "Địa chỉ MAC:";
        _translations["IPv4 Address:"] = "Địa chỉ IPv4:";
        _translations["Gateway IP:"] = "Gateway IP:";
        _translations["DNS Servers:"] = "Máy chủ DNS:";
        _translations["Test Ping Quality"] = "Kiểm tra Ping";
        _translations["Flush DNS Cache"] = "Xóa cache DNS";
        ...
        _translations["TCP Ports Map"] = "Danh sách cổng TCP";
        _translations["Process"] = "Tiến trình";
        _translations["Local Address"] = "Địa chỉ cục bộ";
        _translations["Foreign Address"] = "Địa chỉ đích";
        _translations["Status Status"] = "Trạng thái";

        // --- System Repair Page ---
        _translations["System File Integrity Check"] = "Kiểm tra tệp hệ thống";
        _translations["Scan and repair damaged Windows system files (SFC & DISM tools)."] = "Quét và tự động sửa lỗi tệp hệ thống Windows (SFC & DISM).";
        _translations["Active System Audits Log"] = "Nhật ký sửa lỗi hệ thống";
        _translations["Repair Tool options"] = "Tùy chọn sửa lỗi";
        _translations["Execute SFC Integrity Scan"] = "Quét & Sửa lỗi SFC";
        _translations["DISM Restore Health Scan"] = "Phục hồi sức khỏe DISM";
        _translations["Rebuild Icon & Thumbnail Cache"] = "Làm mới cache Icon & Thumbnail";
        _translations["Re-Register Windows Store Apps"] = "Đăng ký lại ứng dụng Windows Store";
        _translations["Clear Print Spooler Queue"] = "Xóa hàng đợi in";
        _translations["Reset Network Sockets (Winsock)"] = "Đặt lại mạng Winsock";
        _translations["Ready to execute repair routines"] = "Sẵn sàng sửa chữa hệ thống";
        _translations["Starting System File Checker (SFC) scan..."] = "Bắt đầu quét System File Checker (SFC)...";
        _translations["SFC Scan completed. Integrity errors resolved."] = "Quét SFC hoàn tất. Lỗi tệp đã được sửa.";
        _translations["Starting DISM Component Store Cleanup & Health Restore..."] = "Đang chạy DISM phục hồi hệ thống...";
        _translations["DISM Restore Health finished successfully."] = "Phục hồi sức khỏe DISM hoàn tất.";
        _translations["Rebuilding Windows Icon and Thumbnail database cache..."] = "Đang làm mới bộ nhớ đệm Icon và Thumbnail...";
        _translations["Re-registering all Windows Store applications package definitions..."] = "Đang đăng ký lại các gói ứng dụng Store...";
        _translations["Stopping Print Spooler, clearing spool queue files, and restarting service..."] = "Đang xóa hàng đợi in và khởi động lại dịch vụ...";
        _translations["Resetting TCP/IP Winsock catalog sockets definitions..."] = "Đang đặt lại cấu hình mạng Winsock...";

        // --- Security Shield Page ---
        _translations["Security & Privacy Audits"] = "Bảo mật & Quyền riêng tư";
        _translations["Local security configurations, system firewalls status, and telemetry settings tracking."] = "Kiểm tra tường lửa, Defender, UAC và quyền riêng tư.";
        _translations["Anti-Malware Realtime Shield"] = "Bảo vệ thời gian thực";
        _translations["System Firewall Protection"] = "Tường lửa hệ thống";
        _translations["User Account Control (UAC) Checks"] = "Kiểm soát tài khoản người dùng (UAC)";
        _translations["Telemetry Logging & Privacy Alerts"] = "Dữ liệu đo lường & Quyền riêng tư";
        _translations["Active Realtime protection shield monitors for malicious software executions."] = "Bảo vệ thời gian thực chống virus và mã độc.";
        _translations["Local Windows Defender system firewall monitors incoming network threads."] = "Tường lửa kiểm soát các kết nối mạng an toàn.";
        _translations["UAC validates admin permission elevation confirmation dialogue box prompts."] = "Kiểm soát hộp thoại xác nhận quyền Quản trị viên (UAC).";
        _translations["Telemetry logs diagnostics reporting data variables to remote cloud infrastructure."] = "Chặn gửi dữ liệu chẩn đoán cá nhân về máy chủ Microsoft.";
        _translations["System Firewalls Status: Secured"] = "Tường lửa: Đang bảo vệ";
        _translations["System Firewalls Status: Action Required"] = "Tường lửa: Cần bật";
        _translations["UAC Level Validation: Secured"] = "Mức UAC: Chuẩn an toàn";
        _translations["UAC Level Validation: Action Required"] = "Mức UAC: Cần điều chỉnh";
        _translations["Realtime Shield Status: Secured"] = "Bảo vệ thời gian thực: Đang bật";
        _translations["Realtime Shield Status: Action Required"] = "Bảo vệ thời gian thực: Cần bật";
        _translations["Telemetry Logs Status: Telemetry Enabled"] = "Dữ liệu gửi đi: Đang bật";
        _translations["Telemetry Logs Status: Secured (Private)"] = "Dữ liệu gửi đi: Đã chặn (Riêng tư)";
        _translations["Scan Security"] = "Quét bảo mật";
        _translations["Apply Security Fixes"] = "Áp dụng bảo mật";
        _translations["Ready to perform security audit scan"] = "Sẵn sàng kiểm tra bảo mật";
        _translations["Securing firewalls, fixing Defender settings, adjusting UAC, disabling telemetry logs..."] = "Đang bật tường lửa, Defender, UAC và bảo vệ quyền riêng tư...";
        _translations["Security hardening completed successfully."] = "Tăng cường bảo mật hoàn tất.";

        // --- System Optimizer Page ---
        _translations["Active Optimization Engine Tweaks"] = "Tối ưu hóa hệ thống";
        _translations["Speed up file tree access, configure background scheduler services, and optimize memory load."] = "Tăng tốc Windows, dọn RAM và tối ưu các dịch vụ chạy ngầm.";
        _translations["System Optimization registry settings tweaks"] = "Tinh chỉnh Registry tối ưu hệ thống";
        _translations["Scan Optimize System Registry"] = "Quét & Tối ưu Registry";
        _translations["Apply Selected Tweaks"] = "Áp dụng tinh chỉnh đã chọn";
        _translations["Ready to load system optimizer tweaks"] = "Sẵn sàng tải tinh chỉnh tối ưu";
        _translations["Loading registry tweaks..."] = "Đang tải tinh chỉnh registry...";
        _translations["Optimizing selected registry tweaks..."] = "Đang áp dụng tinh chỉnh đã chọn...";
        _translations["System registry tweaks applied successfully."] = "Đã áp dụng tinh chỉnh registry thành công.";

        // --- Startup & Services Page ---
        _translations["Startup & Background Services"] = "Khởi động & Dịch vụ ngầm";
        _translations["Speed up Windows boot times by disabling redundant startup programs and system services."] = "Tắt ứng dụng khởi động và dịch vụ thừa để Windows mở nhanh hơn.";
        _translations["Startup Programs"] = "Ứng dụng khởi động";
        ...
        _translations["Startup Health"] = "Sức khỏe khởi động";
        _translations["Startup Health Score"] = "Điểm sức khỏe khởi động";
        _translations["Smart Insights"] = "Đề xuất thông minh";
        _translations["Smart Optimizer Insights"] = "Phân tích trình tối ưu";
        _translations["Boost Boot Speed"] = "Tăng tốc khởi động";
        ...
        _translations["Disable {0} high/critical impact startup applications to boost boot speeds by up to 30%."] = "Vô hiệu hóa {0} ứng dụng khởi động mức cao/nghiêm trọng giúp tăng tốc mở máy tới 30%.";
        _translations["There are {0} running non-Microsoft background services. Consider disabling those you don't use regularly."] = "Có {0} dịch vụ nền bên thứ ba đang chạy. Hãy tắt các dịch vụ không thường xuyên dùng.";
        _translations["Found {0} active third-party scheduled tasks running in the background. Disabling them saves system overhead."] = "Phát hiện {0} tác vụ lịch bên thứ ba đang chạy nền. Vô hiệu hóa để tiết kiệm tài nguyên.";
        _translations["Excellent! Your Windows startup and background services are fully optimized."] = "Tuyệt vời! Danh sách khởi động và dịch vụ hệ thống của bạn đã được tối ưu hoàn hảo.";
        ...
        _translations["App Uninstaller & Leftovers Cleaner"] = "Gỡ ứng dụng & Dọn tàn dư";
        _translations["Cleanly uninstall Win32 programs and Store packages, wiping orphaned registry entries and residual files."] = "Gỡ sạch phần mềm Win32 và Store, xóa sạch tàn dư registry và tệp thừa.";
        ...
        _translations["Search apps by name, publisher, version..."] = "Tìm ứng dụng theo tên, nhà phát triển...";
        _translations["Filter:"] = "Bộ lọc:";
        _translations["All Types"] = "Tất cả loại";
        ...
        _translations["Uninstall"] = "Gỡ cài đặt";
        _translations["Application Specifications"] = "Thông Tin Chi Tiết";
        _translations["Version:"] = "Phiên bản:";
        ...
        _translations["Force Wipe & Residual Clean"] = "Gỡ cưỡng bức & Dọn tàn dư";
        _translations["Search App Online"] = "Tìm kiếm Online";
        _translations["No application selected"] = "Chưa chọn ứng dụng";
        _translations["Choose an app from the list to view detailed specifications and advanced actions."] = "Chọn ứng dụng từ danh sách để xem chi tiết và gỡ bỏ.";
        _translations["Batch Actions"] = "Thao tác hàng loạt";
        _translations["Multiple applications are selected for queued execution"] = "Đã chọn nhiều ứng dụng để xử lý hàng loạt";
        _translations["Standard Uninstall Selected"] = "Gỡ chuẩn mục đã chọn";
        _translations["Force Wipe Selected"] = "Gỡ cưỡng bức mục đã chọn";
        _translations["App Uninstallation Engine"] = "Bộ máy gỡ ứng dụng";
        _translations["Uninstallation & Scan Progress"] = "Tiến trình gỡ & quét tàn dư";
        _translations["Leftovers Scanner Discovery"] = "Kết quả quét tàn dư";
        _translations["The following leftover components, registry keys, and directories were detected."] = "Phát hiện các tệp và khóa registry tàn dư sau:";
        _translations["Residual Items Found"] = "Tàn dư phát hiện";
        _translations["Reclaimable Space"] = "Dung lượng thu hồi";
        _translations["Residual Item Details"] = "Chi tiết tàn dư";
        _translations["Cancel & Back"] = "Hủy & Quay lại";
        _translations["Wipe Leftovers"] = "Dọn sạch tàn dư";
        _translations["Wiping Leftovers..."] = "Đang dọn sạch tàn dư...";
        _translations["Select / Deselect All Leftovers"] = "Chọn / Bỏ chọn tất cả";
        _translations["Select / Deselect All"] = "Chọn / Bỏ chọn tất cả";
        _translations["Scanning registry for installed applications..."] = "Đang quét các ứng dụng đã cài đặt...";
        _translations["Loaded {0} applications."] = "Đã tìm thấy {0} ứng dụng.";
        _translations["Scan failed:"] = "Quét thất bại:";
        _translations["Uninstalling {0}..."] = "Đang gỡ {0}...";
        _translations["Scanning leftovers for {0}..."] = "Đang quét tàn dư cho {0}...";
        _translations["Scanned {0} leftover items."] = "Phát hiện {0} mục tàn dư.";
        _translations["Successfully uninstalled. No leftovers found."] = "Gỡ thành công. Không có tàn dư.";
        _translations["Uninstallation failed:"] = "Gỡ cài đặt thất bại:";
        _translations["Force uninstalling {0} ({1}/{2})..."] = "Đang gỡ cưỡng bức {0} ({1}/{2})...";
        _translations["Uninstalling {0} ({1}/{2})..."] = "Đang gỡ {0} ({1}/{2})...";
        _translations["Batch uninstall completed successfully. No leftovers found."] = "Gỡ hàng loạt hoàn tất thành công.";
        _translations["Batch uninstallation encountered an error:"] = "Gỡ hàng loạt gặp lỗi:";
        _translations["Deleting leftover components..."] = "Đang dọn tàn dư...";
        _translations["Cleaned {0} leftover files and registry entries."] = "Đã dọn sạch {0} tệp và registry tàn dư.";
        _translations["Error deleting leftovers:"] = "Lỗi khi xóa tàn dư:";
        _translations["Leftover deletion cancelled."] = "Đã hủy xóa tàn dư.";
        _translations["Error opening folder:"] = "Lỗi khi mở thư mục:";
        _translations["Error opening registry:"] = "Lỗi khi mở registry:";
        _translations["Error searching online:"] = "Lỗi khi tìm kiếm:";
        _translations["Uninstaller Failed or Cancelled"] = "Trình gỡ cài đặt bị hủy hoặc lỗi";
        _translations["The standard uninstaller for {0} could not be completed. Would you like to perform a Force Uninstall (wipe its residual files and registry entries)?"] = "Trình gỡ chuẩn cho {0} bị lỗi. Bạn có muốn Gỡ Cưỡng Bức để xóa sạch tàn dư không?";
        _translations["Force Uninstall"] = "Gỡ cưỡng bức";

        // --- Process Manager Page ---
        _translations["Active Processes List"] = "Danh sách tiến trình";
        _translations["Monitor system threads load, active CPU footprints, and memory allocation tables."] = "Giám sát tiến trình, mức dùng CPU và bộ nhớ RAM.";
        _translations["Active system task processes list"] = "Tiến trình đang hoạt động";
        _translations["Reload Processes"] = "Tải lại";
        _translations["Kill Selected Tasks"] = "Dừng mục đã chọn";
        _translations["Ready to monitor system processes"] = "Sẵn sàng giám sát tiến trình";
        _translations["Loading active system processes..."] = "Đang tải danh sách tiến trình...";
        _translations["Processes list loaded successfully."] = "Đã tải danh sách tiến trình.";
        _translations["Terminating selected processes..."] = "Đang dừng tiến trình đã chọn...";
        _translations["Selected processes terminated."] = "Đã dừng các tiến trình đã chọn.";

        // --- Disk Tools Page ---
        _translations["Allocation Directory Weight (Double-click card to Zoom In)"] = "Phân bổ dung lượng (Click đúp để xem chi tiết)";
        _translations["Local storage volumes health, physical S.M.A.R.T attributes, and hardware controllers status."] = "Kiểm tra sức khỏe ổ đĩa, thông số SMART và dọn dẹp dung lượng.";
        _translations["Analysis Target Folder"] = "Thư mục phân tích";
        _translations["Analyze Folder"] = "Phân tích thư mục";
        _translations["Find identical files (MD5 / SHA-256) and execute one-click smart batch deletion."] = "Tìm tệp trùng lặp (SHA-256) và xóa hàng loạt nhanh chóng.";
        _translations["Scan Duplicates"] = "Quét tệp trùng";
        _translations["Delete Pre-Selected"] = "Xóa tệp đã chọn";
        _translations["Disk Overview"] = "Tổng quan ổ đĩa";
        _translations["Space Analyzer"] = "Phân tích dung lượng";
        _translations["Duplicate Finder"] = "Tìm tệp trùng lặp";

        // --- Hardware Center Page ---
        _translations["Hardware Specifications"] = "Thông tin phần cứng";
        _translations["Physical sensors temperature monitors, Motherboard features, and Bios diagnostic components."] = "Nhiệt độ cảm biến, thông số bo mạch chủ và BIOS.";
        _translations["Active Hardware Components Specs"] = "Thông số phần cứng";
        _translations["Central Processor Unit (CPU)"] = "Vi xử lý (CPU)";
        _translations["System Memory (RAM)"] = "Bộ nhớ (RAM)";
        _translations["Motherboard & Bios firmware"] = "Bo mạch chủ & BIOS";
        _translations["Graphics Processing Unit (GPU)"] = "Card đồ họa (GPU)";
        _translations["Storage Disks & Partitioning"] = "Ổ đĩa lưu trữ & Phân vùng";
        _translations["Operating System details"] = "Hệ điều hành";
        _translations["Reload Specs"] = "Tải lại";
        _translations["Ready to load hardware specifications"] = "Sẵn sàng tải thông tin phần cứng";
        _translations["Loading physical hardware components specifications..."] = "Đang đọc thông số phần cứng...";
        _translations["Hardware specs loaded successfully."] = "Đã tải thông tin phần cứng.";

        // --- Registry Center Page ---
        _translations["Registry Issues Scanner"] = "Quét lỗi Registry";
        _translations["Scan registry database branches (Shared DLLs, shortcuts, file extensions) and clean corruption."] = "Quét và sửa lỗi khóa Registry, phím tắt và đuôi tệp hỏng.";
        _translations["Scan Registry Issues"] = "Quét lỗi Registry";
        _translations["Fix Selected Registry Issues"] = "Sửa lỗi đã chọn";
        _translations["Registry Backups History"] = "Lịch sử sao lưu";
        _translations["Create Registry Backup Hive"] = "Tạo bản sao lưu";
        _translations["Restore Registry Backup Hive"] = "Khôi phục sao lưu";
        _translations["Ready to perform registry analysis"] = "Sẵn sàng phân tích Registry";
        ...
        _translations["Fixing selected registry database keys..."] = "Đang sửa khóa Registry đã chọn...";
        _translations["Registry issues fixed successfully."] = "Đã sửa lỗi Registry thành công.";
        _translations["Creating registry hive backup files..."] = "Đang sao lưu Registry...";
        _translations["Registry backup created successfully."] = "Sao lưu Registry thành công.";
        _translations["Restoring system registry hive from backup file..."] = "Đang khôi phục Registry từ tệp sao lưu...";
        _translations["Registry backup restored successfully. Please restart your PC to apply updates."] = "Khôi phục Registry thành công. Hãy khởi động lại máy để áp dụng.";

        // --- Software Updater Page ---
        _translations["Software Updates Manager"] = "Cập nhật phần mềm";
        _translations["Scan installed software applications using Winget engine and update out-of-date tools."] = "Quét và cập nhật phần mềm đã cài đặt qua Winget.";
        _translations["Active installed software updates check list"] = "Danh sách bản cập nhật phần mềm";
        _translations["Scan Available Updates"] = "Quét cập nhật";
        _translations["Upgrade Selected Applications"] = "Cập nhật mục đã chọn";
        _translations["Ready to scan software updates"] = "Sẵn sàng quét cập nhật";
        _translations["Scanning winget packages database..."] = "Đang quét phần mềm qua Winget...";
        _translations["Software updates scan completed."] = "Quét cập nhật hoàn tất.";
        _translations["Upgrading selected application software package models..."] = "Đang cập nhật phần mềm đã chọn...";
        _translations["Software packages upgraded successfully."] = "Cập nhật phần mềm thành công.";

        // --- Driver Updater Page ---
        _translations["Driver Updates Manager"] = "Cập nhật Driver";
        _translations["Scan hardware controllers and display card drivers and apply security hotfixes updates."] = "Quét và cập nhật Driver phần cứng mới nhất.";
        _translations["Active hardware sensors and driver updates list"] = "Danh sách Driver có bản mới";
        _translations["Scan Available Drivers"] = "Quét Driver";
        _translations["Update Selected Drivers"] = "Cập nhật Driver đã chọn";
        _translations["Ready to scan driver updates"] = "Sẵn sàng quét Driver";
        _translations["Querying PnP controllers database files..."] = "Đang kiểm tra thiết bị PnP...";
        _translations["Driver updates scan completed."] = "Quét Driver hoàn tất.";
        _translations["Installing selected driver packages in the background..."] = "Đang cài đặt Driver...";
        _translations["Driver updates installed successfully."] = "Cài đặt Driver thành công.";

        // --- Software Updates Settings / Messages ---
        _translations["Checking for updates..."] = "Đang kiểm tra cập nhật...";
        _translations["New version {remoteVerStr} is available."] = "Đã có phiên bản mới {remoteVerStr}.";
        _translations["You are running the latest version (v{currentVersion.ToString(3)})."] = "Bạn đang dùng phiên bản mới nhất (v{currentVersion.ToString(3)}).";
        _translations["Downloading update..."] = "Đang tải bản cập nhật...";
        _translations["Launching installer..."] = "Đang chạy trình cài đặt...";
        _translations["Purge Complete"] = "Dọn sạch hoàn tất";
        _translations["Database logs and compiled report documents successfully purged."] = "Đã xóa sạch nhật ký cơ sở dữ liệu và báo cáo.";
        _translations["Purge Failed"] = "Xóa thất bại";
        _translations["Accent Color Applied"] = "Đã đổi màu nhấn";
        _translations["System accent color successfully updated to {tag}."] = "Đã cập nhật màu nhấn thành {tag}.";
        _translations["Diagnostics Trace logs"] = "Nhật ký chẩn đoán";
        _translations["Language Saved / Ngôn ngữ đã lưu"] = "Ngôn ngữ đã lưu";
        _translations["Language setting has been updated. Please restart the application to apply the changes.\n\nCài đặt ngôn ngữ đã được cập nhật. Vui lòng khởi động lại ứng dụng để áp dụng thay đổi."] = "Cài đặt ngôn ngữ đã được cập nhật thành công.";
        ...
        // --- Power Options & Graceful Shutdown Overlay ---
        _translations["Power Options"] = "Nguồn & Thoát";
        _translations["Minimize to Tray"] = "Thu nhỏ xuống khay";
        _translations["Shutdown"] = "Tắt ứng dụng";
        _translations["Shut Down"] = "Tắt ứng dụng";
        _translations["Shut Down WinCare"] = "Tắt ứng dụng";
        _translations["Shut Down WinCare Pro"] = "Tắt ứng dụng";
        _translations["Shutting Down"] = "Đang tắt ứng dụng";
        _translations["Securing database, flushing memory caches & closing services..."] = "Đang lưu dữ liệu và giải phóng tài nguyên...";
        _translations["Saving session state & active modules..."] = "Đang lưu trạng thái làm việc...";
        _translations["Flushing SQLite WAL checkpoint & memory pools..."] = "Đang lưu cơ sở dữ liệu và dọn bộ đệm...";
        _translations["Disposing telemetry engines & system monitors..."] = "Đang đóng các dịch vụ giám sát...";
        _translations["All resources secured. Goodbye!"] = "Đã giải phóng tài nguyên. Tạm biệt!";
        _translations["Session Terminated"] = "Đã tắt hoàn tất";
        _translations["Closing database connections and freeing resources..."] = "Đang đóng kết nối dữ liệu và giải phóng tài nguyên...";
        _translations["Finalizing shutdown..."] = "Đang hoàn tất...";
        
        // --- Startup Screen Loader ---
        _translations["Initializing core system engine..."] = "Khởi tạo hệ thống...";
        _translations["Loading database & telemetry store..."] = "Tải cơ sở dữ liệu...";
        _translations["Applying visual themes & typography..."] = "Áp dụng giao diện...";
        _translations["Applying localized linguistic model..."] = "Tải ngôn ngữ...";
        _translations["Launching WinCare Pro workspace..."] = "Mở không gian làm việc...";
        _translations["Ready!"] = "Sẵn sàng!";
        _translations["Next-Gen System Care & Optimization Suite"] = "Bộ công cụ tối ưu & chăm sóc hệ thống thế hệ mới";
        
        // --- Additional Dashboard and System strings ---
        _translations["PC Health Issues Detected"] = "Phát hiện vấn đề sức khỏe PC";
        _translations["High Memory Usage Bottleneck"] = "RAM đang quá tải";
        _translations["Security Telemetry Logs Leak"] = "Đang gửi dữ liệu đo lường về Microsoft";
        _translations["Outdated Software Packages"] = "Phần mềm đã cũ";
        _translations["Startup applications delay"] = "Ứng dụng khởi động làm chậm máy";
        _translations["Disk Temp Alert"] = "Cảnh báo nhiệt độ ổ đĩa";
        _translations["Disk storage clutter volume"] = "Có nhiều tệp rác chiếm ổ đĩa";
        _translations["Registry Integrity Anomalies"] = "Phát hiện lỗi Registry";
        _translations["CPU temperature levels"] = "Nhiệt độ CPU";
        ...
        _translations["Active CPU processor load is normal."] = "Tải lượng CPU bình thường.";
        _translations["High load bottleneck on CPU processor thread."] = "CPU đang quá tải.";
        _translations["Hardware Sensor Temperature"] = "Nhiệt độ cảm biến";
        _translations["CPU core temperature is normal."] = "Nhiệt độ CPU bình thường.";
        _translations["Warning: CPU temperature levels exceed safety threshold."] = "Cảnh báo: Nhiệt độ CPU cao vượt mức.";
        _translations["Physical RAM Allocation"] = "Phân bổ RAM";
        _translations["Memory load footprint is normal."] = "Mức dùng RAM bình thường.";
        _translations["Warning: RAM load footprint exceeds safety threshold."] = "Cảnh báo: RAM đang bị chiếm dụng cao.";
        _translations["Storage Drive Space"] = "Dung lượng ổ đĩa";
        _translations["Junk cache size is small and clean."] = "Ổ đĩa sạch sẽ, ít tệp rác.";
        _translations["Junk files clutter is clean."] = "Tệp rác đã được dọn sạch.";
        _translations["Warning: Large junk files clutter size detected."] = "Cảnh báo: Có nhiều tệp rác cần dọn dẹp.";
        _translations["Registry Integrity"] = "Tính toàn vẹn Registry";
        _translations["Registry database integrity checks are normal."] = "Registry ở trạng thái tốt.";
        _translations["Registry errors detected."] = "Phát hiện lỗi Registry.";
        _translations["Registry errors resolved."] = "Lỗi Registry đã được sửa.";
        _translations["Junk files successfully cleaned."] = "Đã dọn sạch tệp rác thành công.";
        _translations["Software Version Checks"] = "Kiểm tra phiên bản phần mềm";
        _translations["All software applications are up-to-date."] = "Tất cả phần mềm đều đã mới nhất.";
        _translations["Outdated software versions detected."] = "Phát hiện phần mềm có bản cập nhật mới.";
        _translations["Active Startup Programs"] = "Ứng dụng khởi động";
        _translations["Startup boot configuration timeline is normal."] = "Thời gian khởi động hệ thống tốt.";
        _translations["Warning: High number of startup applications delayed boot time."] = "Cảnh báo: Nhiều ứng dụng khởi động làm chậm máy.";
        _translations["Network Connection Latency"] = "Độ trễ mạng (Ping)";
        _translations["DNS resolution and network latency are normal."] = "Kết nối mạng và DNS ổn định.";
        _translations["Warning: High latency packet loss detected."] = "Cảnh báo: Mạng chậm hoặc mất gói tin.";
        _translations["System Firewall Check"] = "Tường lửa hệ thống";
        _translations["Firewall protections are active."] = "Tường lửa đang bật.";
        _translations["Firewall protections are inactive."] = "Tường lửa đang tắt.";
        _translations["User Account Control Status"] = "Kiểm soát tài khoản (UAC)";
        _translations["UAC notification shield is active."] = "Thông báo UAC đang bật.";
        ...
        _translations["Finalizing shutdown..."] = "Đang hoàn tất...";
        _translations["Power Options"] = "Nguồn & Thoát";
        _translations["WinCare Pro Session"] = "Phiên làm việc";
        _translations["Power & Exit Options"] = "Nguồn & Thoát";
        _translations["Shut Down WinCare Pro"] = "Tắt ứng dụng";
        _translations["Save state & close completely"] = "Lưu dữ liệu và thoát ứng dụng";
        _translations["Minimize to Tray"] = "Thu nhỏ xuống khay";
        _translations["Keep active in background"] = "Duy trì chạy ngầm";
        ...
        _translations["PEAK DOWNLOAD"] = "TỐC ĐỘ TẢI XUỐNG";
        _translations["PEAK UPLOAD"] = "TỐC ĐỘ TẢI LÊN";
        ...
        _translations["Trace Route"] = "Dò tuyến đường";
        _translations["DNS Lookup"] = "Tra cứu DNS";
        ...
        _translations["Version 4.9.3 (Stable Release)"] = "Phiên bản 4.9.3 (Bản ổn định)";
        _translations["Version 4.9.2 (Stable Release)"] = "Phiên bản 4.9.2 (Bản ổn định)";
        _translations["Version 4.9.1 (Stable Release)"] = "Phiên bản 4.9.1 (Bản ổn định)";
        ...
        _translations["CDN Ready"] = "CDN Sẵn Sàng";
        _translations["Connecting..."] = "Đang kết nối...";
        _translations["Syncing..."] = "Đang đồng bộ...";
        _translations["Offline"] = "Ngoại tuyến";
        _translations["Disconnected"] = "Đã ngắt kết nối";
        _translations["No Connection"] = "Không có kết nối";
        _translations["Connection Failed"] = "Kết nối thất bại";
        _translations["Connection Error"] = "Lỗi kết nối";
        ...
        _translations["Checking for Updates..."] = "Đang kiểm tra cập nhật...";
        _translations["Cancel"] = "Hủy";
        _translations["Cancelled"] = "Đã hủy";
        _translations["Scanning"] = "Đang quét";
        _translations["Idle"] = "Chờ";
        _translations["Ready"] = "Sẵn sàng";
        ...
        _translations["Missing system libraries required for download."] = "Thiếu thư viện hệ thống cần thiết để tải xuống.";
        _translations["An unexpected error occurred during update audit."] = "Đã xảy ra lỗi không mong muốn trong khi kiểm tra cập nhật.";
        _translations["Update Failed"] = "Cập nhật thất bại";
        _translations["No internet connection available to reach update servers."] = "Không có kết nối Internet để liên hệ máy chủ cập nhật.";
        _translations["No active internet connection available."] = "Không có kết nối Internet khả dụng.";
        _translations["Update check cancelled."] = "Đã hủy kiểm tra cập nhật.";
        ...
        _translations["v4.9.3 Orion"] = "v4.9.3 Orion";
        _translations["v4.9.2 Orion"] = "v4.9.2 Orion";
        _translations["v4.9.1 Nova"] = "v4.9.1 Nova";
        ...
        _translations["Orion Suite"] = "Bộ Orion Suite";
        ...
        _translations["Version 4.9.3 (Codename: Orion) • 64-bit Native System Suite"] = "Phiên bản 4.9.3 (Codename: Orion) • Bộ Công Cụ Hệ Thống 64-bit Native";
        _translations["Version 4.9.2 (Codename: Orion) • 64-bit Native System Suite"] = "Phiên bản 4.9.2 (Codename: Orion) • Bộ Công Cụ Hệ Thống 64-bit Native";
        _translations["Version 4.9.1 (Codename: Nova) • 64-bit Native System Suite"] = "Phiên bản 4.9.1 (Codename: Nova) • Bộ Công Cụ Hệ Thống 64-bit Native";
        ...
        _translations["What's New in v4.9.3"] = "Điểm mới trong v4.9.3";
        _translations["What's New in v4.9.2"] = "Điểm mới trong v4.9.2";
        _translations["What's New in v4.9.1"] = "Điểm mới trong v4.9.1";
        ...
        _translations["v4.9.3 Orion Release"] = "Bản Phát Hành v4.9.3 Orion";
        _translations["v4.9.2 Orion Release"] = "Bản Phát Hành v4.9.2 Orion";
        _translations["v4.9.1 Nova Release"] = "Bản Phát Hành v4.9.1 Nova";
        _translations["v4.9 Nova Release"] = "Bản Phát Hành v4.9 Nova";
        _translations["Version 4.9.3 (Orion) • 64-bit Native System Suite"] = "Phiên bản 4.9.3 (Orion) • Bộ Công Cụ Hệ Thống 64-bit Native";
        _translations["Version 4.9.2 (Orion) • 64-bit Native System Suite"] = "Phiên bản 4.9.2 (Orion) • Bộ Công Cụ Hệ Thống 64-bit Native";
        _translations["Version 4.9.1 (Nova) • 64-bit Native System Suite"] = "Phiên bản 4.9.1 (Nova) • Bộ Công Cụ Hệ Thống 64-bit Native";
        ...
        _translations["> 30 Days Free"] = "> 30 Ngày Thoải Mái";
        ...
        _translations["Traceroute"] = "Dò đường mạng";
        ...
        _translations["Real-time network telemetry, low-latency DNS optimizer, socket traffic & TCP/IP repair."] = "Đo lường mạng thời gian thực, tối ưu DNS độ trễ thấp, lưu lượng socket & sửa chữa TCP/IP.";
        _translations["Diagnose and repair Windows components, SFC integrity, and services."] = "Chẩn đoán và sửa chữa các thành phần Windows, tính toàn vẹn SFC và dịch vụ.";
        _translations["Protect system security, hardware trust, and privacy settings."] = "Bảo vệ an ninh hệ thống, độ tin cậy phần cứng và cài đặt quyền riêng tư.";
        _translations["Kernel response tuning, high-speed RAM working set purger, latency reduction, and gaming acceleration."] = "Tinh chỉnh phản hồi kernel, giải phóng nhanh RAM working set, giảm độ trễ & tăng tốc game.";
        _translations["Boost gaming FPS, reduce latency, and optimize CPU priority."] = "Tăng tốc FPS chơi game, giảm độ trễ và tối ưu mức ưu tiên CPU.";
        _translations["Clean up shell extensions, declutter right-click menus, and accelerate Windows File Explorer."] = "Dọn dẹp shell extensions, làm gọn menu chuột phải & tăng tốc Windows Explorer.";
        _translations["Accelerate Windows boot velocity, disable heavy startup applications & configure background services."] = "Tăng tốc khởi động Windows, vô hiệu hóa ứng dụng khởi động nặng & cấu hình dịch vụ nền.";
        _translations["Monitor drive SMART attributes, analyze allocation weight, and safely clean duplicate files."] = "Giám sát thuộc tính SMART ổ đĩa, phân tích dung lượng & dọn tệp trùng lặp an toàn.";
        _translations["Repair corrupted keys, eliminate invalid CLSIDs, streamline shell registrations & defragment registry hives."] = "Sửa lỗi khóa registry hỏng, loại bỏ CLSID không hợp lệ, tinh gọn shell & chống phân mảnh registry.";
        _translations["Update applications and system packages via WinGet."] = "Cập nhật ứng dụng và các gói hệ thống thông qua WinGet.";
        _translations["System alerts, notifications, and optimization activity history."] = "Cảnh báo hệ thống, thông báo và lịch sử hoạt động tối ưu hóa.";

        // --- AI Assistant & Health Engine ---
        _translations["Storage Consumption Outlook Good"] = "Triển Vọng Tiêu Thụ Dung Lượng Tốt";
        _translations["Elevated Process Overhead"] = "Quá Tải Tiến Trình Nền";
        _translations["Background Process Monitoring"] = "Giám Sát Tiến Trình Nền";
        _translations["Predictive Storage Warning"] = "Cảnh Báo Dự Báo Dung Lượng";
        _translations["Storage Consumption Outlook"] = "Triển Vọng Tiêu Thụ Dung Lượng";
        _translations["Storage Forecast"] = "Dự Báo Lưu Trữ";
        _translations["Drive C: exhaustion forecast"] = "Dự báo mức dùng ổ C:";
        _translations["> 30 Days Free"] = "> 30 Ngày Thoải Mái";
        _translations["> 30 Days Left"] = "> 30 Ngày Thoải Mái";
        _translations["Boot Optimization"] = "Tối Ưu Khởi Động";
        _translations["Potential startup shaving"] = "Tiềm năng rút ngắn thời gian khởi động";
        _translations["Memory Index"] = "Chỉ Số Bộ Nhớ";
        _translations["Stable"] = "Ổn Định";
        _translations["Working set & Standby state"] = "Working set & Trạng thái Standby";
        _translations["Stability Vector"] = "Vector Ổn Định";
        _translations["99.9% Optimal"] = "99.9% Tối Ưu";
        _translations["No anomalies detected"] = "Không có sự cố bất thường";
        _translations["Clean Temp Junk"] = "Dọn tệp rác tạm";
        _translations["Optimize Startup Apps"] = "Tối ưu ứng dụng khởi động";
        _translations["Flush DNS & Winsock"] = "Xóa sạch DNS & Winsock";
        _translations["Purge RAM"] = "Giải phóng RAM";
        _translations["Export AI Report"] = "Xuất Báo Cáo AI";
        _translations["Run AI Diagnostics"] = "Chạy Chẩn Đoán AI";
        ...
        _translations["Apply"] = "Áp Dụng";
        _translations["Apply Fix"] = "Áp Dụng";
        _translations["Applied"] = "Đã Áp Dụng";
        _translations["Fix Selected"] = "Sửa Mục Đã Chọn";
        _translations["Repair All"] = "Sửa Tất Cả";
        ...
        _translations["Size"] = "Kích Thước";
        _translations["Action"] = "Hành Động";
        _translations["Win32 Desktop"] = "Win32 Desktop";
        _translations["Store App"] = "Ứng Dụng Store";
        _translations["UWP App"] = "Ứng Dụng UWP";
        _translations["Unknown"] = "Không xác định";

        // --- Junk Cleaner ---
        _translations["Junk Cleaner & System Cache"] = "Dọn Dẹp Rác & Bộ Nhớ Đệm Hệ Thống";
        _translations["Scan Directories"] = "Quét Thư Mục";
        _translations["Clean Now"] = "Dọn Dẹp Ngay";

        // --- Gaming Turbo ---
        _translations["Competitive FPS"] = "FPS Cạnh Tranh";
        _translations["Open-World RPG"] = "RPG Thế Giới Mở";
        _translations["Simulation & Strategy (RTS)"] = "Mô phỏng & Chiến thuật (RTS)";
        _translations["VR / Ultra Quality"] = "Thực tế ảo VR / Chất lượng Tối đa";
        _translations["Purged RAM"] = "RAM Đã Giải Phóng";
        _translations["Clean Standby list & Working sets"] = "Dọn dẹp Standby list & Working sets";
        _translations["Background Apps"] = "Ứng Dụng Nền";
        _translations["Power Plan"] = "Chế Độ Nguồn";
        _translations["Ultimate Performance"] = "Hiệu Năng Đỉnh Cao";
        _translations["Disable CPU Core Parking"] = "Tắt đỗ nhân CPU (Unpark Cores)";
        _translations["TCP Packet Scheduling"] = "Điều phối Gói tin TCP";
        _translations["Optimized gaming sockets"] = "Đã tối ưu kết nối sockets cho game";
        _translations["Foreground Game Process High-Priority"] = "Ưu tiên CPU tối đa cho Game đang mở";
        _translations["Flush Windows Standby List Cache"] = "Xóa sạch bộ nhớ đệm Windows Standby List";
        _translations["TCP NoDelay (Disable Nagle Algorithm during gaming)"] = "TCP NoDelay (Tắt thuật toán Nagle khi chơi game)";
        _translations["TCP NoDelay (Tắt thuật toán Nagle khi chơi game)"] = "TCP NoDelay (Tắt thuật toán Nagle khi chơi game)";
        _translations["Pause Windows Update & Telemetry during gaming"] = "Tạm dừng Windows Update & Telemetry khi Chơi Game";
        _translations["Tạm dừng Windows Update & Telemetry khi Chơi Game"] = "Tạm dừng Windows Update & Telemetry khi Chơi Game";

        // --- Network Page Repaired & Diagnostic Suite ---
        _translations["1-Click TCP/IP & Winsock Repairs"] = "Sửa Lỗi TCP/IP & Winsock 1 Chạm";
        _translations["Resolve DNS failures, socket corruption & IP lease timeouts"] = "Khắc phục lỗi DNS, hỏng socket & hết hạn cấp phát IP";
        _translations["Core Repairs"] = "Sửa Chữa Cốt Lõi";
        _translations["Gaming & Performance Latency Boost"] = "Tăng Tốc Độ Trễ & Hiệu Năng Game";
        _translations["Reduce bufferbloat, lower game ping & clean routing"] = "Giảm nghẽn bộ đệm bufferbloat, hạ ping game & làm sạch định tuyến";
        _translations["Performance Boost"] = "Tăng Tốc Hiệu Năng";
        _translations["Network Diagnostic Terminal"] = "Cửa Sổ Chẩn Đoán Mạng";
        _translations["Live command output and instant network test tools"] = "Đầu ra lệnh trực tiếp và công cụ kiểm tra mạng tức thì";
        _translations["Reset TCP/IP"] = "Đặt Lại TCP/IP";
        _translations["Rebuild TCP/IP stack."] = "Xây dựng lại ngăn xếp TCP/IP.";
        _translations["Reset TCP"] = "Đặt Lại TCP";
        _translations["Reset Winsock"] = "Đặt Lại Winsock";
        _translations["Restore Sockets API."] = "Khôi phục API Sockets.";
        _translations["Renew DHCP"] = "Làm Mới DHCP";
        _translations["Re-request IP lease."] = "Yêu cầu cấp lại IP.";
        _translations["Flush DNS/ARP"] = "Xóa DNS & ARP";
        _translations["Purge cache table."] = "Xóa bảng bộ đệm.";
        _translations["Flush Cache"] = "Xóa Bộ Đệm";
        _translations["Reset Adapters"] = "Khởi Động Lại Card Mạng";
        ...
        _translations["TCP Auto-Tuning"] = "Tự Động Tối Ưu TCP";
        _translations["Unlock max throughput."] = "Mở khóa băng thông tối đa.";
        _translations["Enable Tuning"] = "Bật Tinh Chỉnh";
        _translations["Disable EEE"] = "Tắt Tiết Kiệm Năng Lượng (EEE)";
        _translations["Lower ping in gaming."] = "Giảm ping khi chơi game.";
        _translations["Reset WinHTTP"] = "Đặt Lại WinHTTP";
        _translations["Purge corrupt proxies."] = "Xóa các proxy bị lỗi.";
        _translations["Reset Proxy"] = "Đặt Lại Proxy";
        _translations["Reset Hosts File"] = "Đặt Lại File Hosts";
        _translations["Restore clean hosts."] = "Khôi phục tệp hosts sạch.";
        _translations["Reset Hosts"] = "Đặt Lại Hosts";
        _translations["Rebind IP Lease"] = "Cấp Lại Địa Chỉ IP";
        _translations["Renew DHCP routing."] = "Làm mới định tuyến DHCP.";
        _translations["Rebind IP"] = "Cấp Lại IP";
        _translations["Purge Routing"] = "Xóa Bảng Định Tuyến";
        _translations["Clear socket route cache."] = "Xóa bộ đệm định tuyến socket.";
        _translations["Clear Routes"] = "Xóa Định Tuyến";

        // --- Context Menu Page ---
        _translations["Context Menu Manager"] = "Quản lý Menu chuột phải";
        _translations["Manage shell extensions and declutter right-click menus."] = "Quản lý tiện ích & làm gọn menu chuột phải.";
        _translations["Scan Context Menus"] = "Quét Menu chuột phải";
        _translations["Total Handlers"] = "Tổng mục xử lý";
        _translations["Active in Context Menu"] = "Đang bật trong Menu";
        _translations["Disabled / Shelved"] = "Đã tắt / Tạm ngưng";
        _translations["Search handlers or registry paths..."] = "Tìm kiếm mục xử lý hoặc đường dẫn registry...";
        _translations["Shell Guidelines"] = "Hướng Dẫn Menu Chuột Phải";
        _translations["Disabling unused shell extensions removes right-click popup delay and prevents File Explorer freezes."] = "Vô hiệu hóa tiện ích không dùng giúp menu chuột phải mở tức thì và tránh đơ File Explorer.";
        _translations["Safe Non-Destructive Mod"] = "Chế Độ An Toàn Không Hủy Dữ Liệu";
        _translations["Disabled keys are safely prefixed with '-' rather than deleted, allowing instant restoration anytime."] = "Các khóa bị tắt được gắn tiền tố '-' thay vì bị xóa, cho phép khôi phục tức thì bất kỳ lúc nào.";
        _translations["Installed software (such as archivers, cloud drives, editors) inject shell extensions into Windows right-click menus."] = "Các phần mềm đã cài đặt (như giải nén, ổ đĩa đám mây, trình soạn thảo) tự chèn shell extensions vào menu chuột phải Windows.";
        _translations["Disabling unused shell extensions significantly reduces context menu popup delay and eliminates Explorer freeze."] = "Vô hiệu hóa các shell extensions không dùng giúp giảm đáng kể độ trễ mở menu chuột phải và loại bỏ hiện tượng đơ Explorer.";

        // --- Disk & Storage Page ---
        _translations["Disk & Storage Center"] = "Trung tâm Ổ đĩa & Dung lượng";
        _translations["S.M.A.R.T Shield Active"] = "Khiên S.M.A.R.T Đang Bật";
        _translations["Drives & Volumes"] = "Ổ đĩa & Phân vùng";
        _translations["Drives &amp; Volumes"] = "Ổ đĩa & Phân vùng";
        _translations["Physical Devices"] = "Thiết bị vật lý";
        _translations["Storage Items Analyzed"] = "Mục lưu trữ đã phân tích";
        _translations["Directories & Files"] = "Thư mục & Tệp tin";
        _translations["Directories &amp; Files"] = "Thư mục & Tệp tin";
        _translations["Duplicate File Groups"] = "Nhóm tệp trùng lặp";
        _translations["Reclaimable Clusters"] = "Cụm có thể giải phóng";
        _translations["Disk Overview"] = "Tổng quan ổ đĩa";
        _translations["Local storage volumes health, physical S.M.A.R.T attributes, and hardware controller diagnostics."] = "Sức khỏe các phân vùng ổ đĩa cục bộ, thuộc tính S.M.A.R.T vật lý và chẩn đoán phần cứng.";
        _translations["Target:"] = "Mục tiêu:";
        _translations["Browse..."] = "Duyệt...";
        _translations["Go Up ⮥"] = "Lên thư mục cha ⮥";
        _translations["Clean Empty Folders"] = "Dọn Thư Mục Rỗng";
        _translations["Space Analyzer"] = "Phân Tích Dung Lượng";
        _translations["Duplicate Finder"] = "Tìm Tệp Trùng Lặp";
        _translations["Analyze disk space allocation across large directories and user folders."] = "Phân tích phân bổ dung lượng ổ đĩa qua các thư mục lớn và thư mục người dùng.";
        _translations["Path:"] = "Đường dẫn:";
        _translations["Go Up"] = "Lên Thư Mục Cha";
        _translations["Scan Directory"] = "Quét Thư Mục";
        _translations["Allocation Directory Weight (Double-click folder card to Zoom In)"] = "Trọng Số Phân Bổ Thư Mục (Nhấp đúp vào thẻ để xem chi tiết)";
        _translations["Find identical files using 2-stage verification (Head Hash + SHA-256)."] = "Tìm các tệp trùng lặp giống nhau bằng xác minh 2 giai đoạn (Head Hash + SHA-256).";
        _translations["Selection Tools:"] = "Công Cụ Chọn:";
        _translations["Keep Newest"] = "Giữ Mới Nhất";
        ...
        _translations["SQLite Activity Audit Log Viewer"] = "Trình Xem Nhật Ký Hoạt Động SQLite";
        ...
        // --- Network Center & Diagnostics Suite ---
        _translations["Network Center & Diagnostics"] = "Trung tâm Mạng & Chẩn đoán";
        _translations["Network Center &amp; Diagnostics"] = "Trung tâm Mạng & Chẩn đoán";
        _translations["Network telemetry, DNS speed & TCP/IP repairs."] = "Tối ưu mạng, tốc độ DNS & sửa kết nối TCP/IP.";
        _translations["Network telemetry, DNS speed &amp; TCP/IP repairs."] = "Tối ưu mạng, tốc độ DNS & sửa kết nối TCP/IP.";
        _translations["Run Diagnostics"] = "Chạy chẩn đoán";
        _translations["Quality & Speed"] = "Tốc độ & Chất lượng";
        _translations["DNS Optimizer"] = "Tối ưu DNS";
        _translations["Active Sockets"] = "Kết nối đang mở";
        _translations["TCP/IP Repair Suite"] = "Bộ công cụ sửa TCP/IP";
        _translations["🚀 Quality & Speed"] = "🚀 Tốc độ & Chất lượng";
        _translations["🚀 Quality &amp; Speed"] = "🚀 Tốc độ & Chất lượng";
        _translations["🌐 DNS Optimizer"] = "🌐 Tối ưu DNS";
        _translations["🔍 Active Sockets"] = "🔍 Kết nối đang mở";
        _translations["🛠 TCP/IP Repair Suite"] = "🛠 Bộ công cụ sửa TCP/IP";
        _translations["Latency (Ping)"] = "Độ trễ (Ping)";
        _translations["Round-trip echo"] = "Thời gian phản hồi khứ hồi";
        _translations["Jitter Stability"] = "Độ ổn định Jitter";
        _translations["Buffer variation"] = "Độ biến thiên bộ đệm";
        _translations["Packet Loss"] = "Mất gói tin";
        _translations["Dropped frames ratio"] = "Tỷ lệ mất gói tin";
        _translations["Quality Rating"] = "Đánh giá chất lượng";
        _translations["Network Speed"] = "Tốc độ mạng";
        _translations["Smart Network Auto-Repair"] = "Tự động sửa chữa mạng thông minh";
        _translations["Auto Repair All"] = "Tự động sửa tất cả";
        _translations["Automatically flush DNS, rebuild TCP/IP, renew DHCP leases & optimize throughput in 1 click."] = "Tự động xóa DNS, khôi phục TCP/IP, cấp lại IP DHCP & tối ưu băng thông chỉ với 1-click.";
        _translations["Automatically flush DNS, rebuild TCP/IP, renew DHCP leases &amp; optimize throughput in 1 click."] = "Tự động xóa DNS, khôi phục TCP/IP, cấp lại IP DHCP & tối ưu băng thông chỉ với 1-click.";
        _translations["1-Click TCP/IP & Winsock Repairs"] = "Sửa lỗi TCP/IP & Winsock 1-Click";
        _translations["1-Click TCP/IP &amp; Winsock Repairs"] = "Sửa lỗi TCP/IP & Winsock 1-Click";
        _translations["Resolve DNS failures, socket corruption & IP lease timeouts"] = "Khắc phục lỗi DNS, hỏng socket & hết hạn cấp phát IP";
        _translations["Resolve DNS failures, socket corruption &amp; IP lease timeouts"] = "Khắc phục lỗi DNS, hỏng socket & hết hạn cấp phát IP";
        _translations["Core Repairs"] = "Sửa chữa cốt lõi";
        _translations["Reset TCP/IP"] = "Đặt lại TCP/IP";
        _translations["Rebuild TCP/IP stack."] = "Khôi phục ngăn xếp TCP/IP.";
        _translations["Reset TCP"] = "Đặt lại TCP";
        _translations["Reset Winsock"] = "Đặt lại Winsock";
        _translations["Restore Sockets API."] = "Khôi phục giao diện Sockets API.";
        _translations["Renew DHCP"] = "Cấp lại DHCP";
        _translations["Renew DHCP Lease"] = "Cấp lại địa chỉ DHCP";
        _translations["Request new IP from router."] = "Yêu cầu IP mới từ router.";
        _translations["Flush DNS/ARP"] = "Xóa bộ nhớ đệm DNS/ARP";
        _translations["Purge DNS & ARP caches."] = "Xóa sạch cache DNS & bảng ARP.";
        _translations["Purge DNS &amp; ARP caches."] = "Xóa sạch cache DNS & bảng ARP.";
        _translations["Reset Adapters"] = "Khởi động lại card mạng";
        _translations["Cycle all network adapters."] = "Bật lại tất cả bộ điều hợp mạng.";
        _translations["Repair Firewall"] = "Sửa tường lửa Windows";
        _translations["Restore default rules."] = "Khôi phục quy tắc tường lửa mặc định.";
        _translations["Gaming & Performance Latency Boost"] = "Tăng tốc độ trễ chơi Game & Hiệu năng";
        _translations["Gaming &amp; Performance Latency Boost"] = "Tăng tốc độ trễ chơi Game & Hiệu năng";
        _translations["Reduce ping jitter, optimize congestion algorithms & disable eco packet throttling"] = "Giảm giật ping, tối ưu thuật toán chống nghẽn & tắt giới hạn gói tin";
        _translations["Reduce ping jitter, optimize congestion algorithms &amp; disable eco packet throttling"] = "Giảm giật ping, tối ưu thuật toán chống nghẽn & tắt giới hạn gói tin";
        _translations["Low Latency Mode"] = "Chế độ độ trễ thấp";
        _translations["TCP Auto-Tuning"] = "Tự động điều chỉnh TCP";
        _translations["Optimize window size."] = "Tối ưu kích thước TCP window.";
        _translations["Enable Auto-Tuning"] = "Bật tự động điều chỉnh";
        _translations["Disable EEE"] = "Tắt tiết kiệm điện mạng (EEE)";
        _translations["Disable Energy-Efficient Ethernet."] = "Tắt chế độ tiết kiệm điện Ethernet.";
        _translations["Disable EEE (Green)"] = "Tắt EEE";
        _translations["Reset WinHTTP"] = "Đặt lại WinHTTP";
        _translations["Clear proxy configurations."] = "Xóa cấu hình proxy hệ thống.";
        _translations["Reset Hosts File"] = "Đặt lại tệp Hosts";
        _translations["Restore default Windows hosts file."] = "Khôi phục tệp hosts Windows mặc định.";
        _translations["Reset Hosts"] = "Đặt lại Hosts";
        _translations["Rebind IP Lease"] = "Cập nhật lại cấp phát IP";
        _translations["Release and renew all bindings."] = "Giải phóng và xin cấp lại IP.";
        _translations["Purge Routing"] = "Xóa bảng định tuyến";
        _translations["Clear persistent routing table."] = "Xóa sạch bảng định tuyến tồn đọng.";
        _translations["Purge Route"] = "Xóa định tuyến";
        _translations["Network Diagnostic Terminal"] = "Cửa sổ lệnh chẩn đoán mạng";
        _translations["Live command output and instant network test tools"] = "Kết quả lệnh thời gian thực và công cụ kiểm tra mạng";
        _translations["Ping"] = "Kiểm tra Ping";
        _translations["Traceroute"] = "Dò đường truyền (Trace)";
        _translations["DNS"] = "Tra cứu DNS";
        _translations["Port Scan"] = "Quét cổng (Port)";
        _translations["Hardware Network Interfaces"] = "Giao diện mạng phần cứng";
        _translations["Physical network controllers and active IP routing"] = "Bộ điều khiển mạng vật lý và bảng định tuyến IP";
        _translations["Fastest:"] = "Nhanh nhất:";
        _translations["Optimize DNS"] = "Tối ưu DNS";
        _translations["Restore DHCP"] = "Khôi phục DHCP";
        _translations["Revert adapter DNS to automatic DHCP assigned by router"] = "Chuyển DNS về chế độ tự động từ Router (DHCP)";
        _translations["DoH Encrypted DNS"] = "DNS mã hóa (DoH)";
        _translations["Inbound throughput"] = "Băng thông tải xuống (Inbound)";
        _translations["Outbound throughput"] = "Băng thông tải lên (Outbound)";
        _translations["Latency deviation"] = "Độ lệch độ trễ";
        _translations["Refresh Sockets"] = "Làm mới kết nối Sockets";
        _translations["Local Endpoint"] = "Điểm kết nối nội bộ";
        _translations["Remote Endpoint"] = "Điểm kết nối từ xa";

        // --- System Diagnostics, Repair & Core Suites ---
        _translations["System Diagnostics & Repair"] = "Chẩn đoán & Sửa chữa hệ thống";
        _translations["System Diagnostics &amp; Repair"] = "Chẩn đoán & Sửa chữa hệ thống";
        _translations["System Optimization & Care Suite"] = "Bộ công cụ tối ưu & Chăm sóc hệ thống";
        _translations["System Optimization &amp; Care Suite"] = "Bộ công cụ tối ưu & Chăm sóc hệ thống";
        _translations["Threat protection & firewall."] = "Bảo vệ mối đe dọa & tường lửa.";
        _translations["Threat protection &amp; firewall."] = "Bảo vệ mối đe dọa & tường lửa.";
        _translations["Hardware, BIOS & drivers."] = "Phần cứng, BIOS & trình điều khiển.";
        _translations["Hardware, BIOS &amp; drivers."] = "Phần cứng, BIOS & trình điều khiển.";
        _translations["Windows Defender, Firewall, and privacy telemetry settings."] = "Cài đặt Windows Defender, Tường lửa và quyền riêng tư telemetry.";
        _translations["Windows system file checker, DISM repair, and subsystem restoration."] = "Kiểm tra tệp hệ thống Windows (SFC), sửa chữa DISM và phục hồi phân hệ.";
        _translations["Drive S.M.A.R.T. health, duplicate finder, and large files analyzer."] = "Sức khỏe S.M.A.R.T. ổ đĩa, tìm tệp trùng và phân tích tệp lớn.";
        _translations["Disk & Storage"] = "Ổ đĩa & Lưu trữ";
        _translations["Disk &amp; Storage"] = "Ổ đĩa & Lưu trữ";
        _translations["Registry Center & Optimizer"] = "Trung tâm & Tối ưu Registry";
        _translations["Registry Center &amp; Optimizer"] = "Trung tâm & Tối ưu Registry";
        _translations["Registry Engine Status"] = "Trạng thái động cơ Registry";
        _translations["Registry Issues & Invalid References"] = "Lỗi Registry & Liên kết không hợp lệ";
        _translations["Registry Issues &amp; Invalid References"] = "Lỗi Registry & Liên kết không hợp lệ";
        _translations["Total Cleanable Space"] = "Tổng dung lượng có thể dọn dẹp";
        _translations["Ready to Scan Caches"] = "Sẵn sàng quét bộ nhớ đệm";
        _translations["Select All Categories"] = "Chọn tất cả danh mục";
        _translations["Deselect All Categories"] = "Bỏ chọn tất cả danh mục";
        _translations["Scan and safely clean temporary files, cache, and system clutter."] = "Quét và dọn dẹp an toàn tệp tạm, bộ nhớ đệm và rác hệ thống.";
        _translations["Uninstall desktop and Store apps with deep leftover cleanup."] = "Gỡ cài đặt ứng dụng máy tính và Store với tính năng dọn sạch tệp thừa.";
        _translations["Scan and update installed third-party software applications."] = "Quét và cập nhật các phần mềm của bên thứ ba đã cài đặt.";
        _translations["Overview of system health, hardware telemetry, and one-click quick boost."] = "Tổng quan sức khỏe hệ thống, tài nguyên phần cứng và tăng tốc 1-click.";
        _translations["Invalid Keys Scanner • 1-Click Rollback Backup • Orphaned Traces"] = "Quét khóa Registry không hợp lệ • Sao lưu khôi phục 1-Click • Khắc phục tệp thừa";
        _translations["Intelligent Health Engine • Predictive Storage • Kernel Analysis"] = "Động cơ chẩn đoán thông minh • Dự báo dung lượng • Phân tích hệ thống";
        _translations["Kernel Performance Tuning • UI Responsiveness • RAM Maintenance"] = "Tinh chỉnh hiệu năng nhân hệ thống • Phản hồi UI • Bảo trì RAM";
        _translations["Explorer Shell Extension Cleaner • Right-Click Menu Speedup"] = "Dọn dẹp tiện ích Shell Explorer • Tăng tốc menu chuột phải";
        _translations["Space Analyzer • SSD TRIM Optimization • Predictive Life Metrics"] = "Phân tích dung lượng • Tối ưu SSD TRIM • Dự báo tuổi thọ ổ đĩa";
        _translations["SFC Integrity Check • DISM Health Restore • Windows Update Auto-Fix"] = "Kiểm tra toàn vẹn SFC • Khôi phục hệ thống DISM • Tự động sửa lỗi Windows Update";
        _translations["Silent App Updates • Winget Integration • Security Patch Scanning"] = "Cập nhật ứng dụng ngầm • Tích hợp WinGet • Quét bản vá bảo mật";
        _translations["Floating HUD Overlay • 1-Click Desktop RAM Boost • Always-on-Top"] = "Tiện ích nổi HUD • Giải phóng RAM 1-Click • Luôn hiển thị trên cùng";
        ...
        _translations["WinCare HUD"] = "Tiện ích WinCare HUD";
        _translations["Toggle HUD Widget"] = "Bật/Tắt tiện ích HUD";
        _translations["RAM Memory Booster - Click for 1-Click RAM Purge"] = "Tăng tốc bộ nhớ RAM - Bấm để giải phóng RAM tức thì";
        _translations["CPU Usage Monitor - Click to view Dashboard performance"] = "Giám sát CPU - Bấm để xem hiệu năng Bảng điều khiển";
        _translations["No matching modules found"] = "Không tìm thấy mô-đun phù hợp";
        _translations["Try searching for another keyword like 'clean', 'speed', 'ram', 'game', 'restore', or select 'All Modules'."] = "Thử tìm kiếm với từ khóa khác như 'dọn dẹp', 'tốc độ', 'ram', 'game', 'khôi phục' hoặc chọn 'Tất cả mô-đun'.";
        _translations["WinCare Pro Sentinel is continuously monitoring your system health."] = "WinCare Pro Sentinel đang liên tục giám sát sức khỏe hệ thống.";
        _translations["Scan for Updates"] = "Quét tìm bản cập nhật";
        _translations["No pending software updates detected for your system."] = "Hệ thống không có bản cập nhật phần mềm nào đang chờ.";
        _translations["Software Security Index"] = "Chỉ số bảo mật phần mềm";
        _translations["WinGet Repository & Direct Channel Synced"] = "Kho lưu trữ WinGet & Kênh cập nhật trực tiếp đã đồng bộ";
        _translations["WinGet Repository &amp; Direct Channel Synced"] = "Kho lưu trữ WinGet & Kênh cập nhật trực tiếp đã đồng bộ";
        _translations["Terminate Process (Kill)"] = "Dừng tiến trình ngay (Kill)";
        _translations["Open Process Location"] = "Mở vị trí tệp tiến trình";
        _translations["Open Windows Services Manager"] = "Mở Quản lý dịch vụ Windows (services.msc)";
        _translations["Open Task Manager Services View"] = "Mở xem Dịch vụ trong Task Manager";
        _translations["Permanently delete from startup"] = "Xóa vĩnh viễn khỏi khởi động";
        _translations["Permanently delete scheduled task"] = "Xóa vĩnh viễn tác vụ lịch trình";
        _translations["Search apps, services, or tasks..."] = "Tìm ứng dụng, dịch vụ hoặc tác vụ...";
        _translations["Search package..."] = "Tìm gói cài đặt...";
        _translations["Search guide (e.g., RAM, DNS, SFC, junk)..."] = "Tìm kiếm hướng dẫn (VD: RAM, DNS, SFC, rác)...";
        _translations["Management Consoles"] = "Bảng điều khiển quản trị";
        _translations["Management Tools"] = "Công cụ quản trị hệ thống";
        _translations["Create Full Safety Backup"] = "Tạo sao lưu an toàn toàn diện";
        _translations["Zero Risk Guarantee"] = "Cam kết an toàn tuyệt đối";
        _translations["Need Technical Support?"] = "Cần hỗ trợ kỹ thuật?";
        _translations["Visit the GitHub repository or submit an issue via Settings > About WinCare Pro for rapid technical guidance."] = "Truy cập kho lưu trữ GitHub hoặc gửi yêu cầu qua Cài đặt > Giới thiệu WinCare Pro để được hỗ trợ nhanh chóng.";
        _translations["Diagnostic Telemetry"] = "Dữ liệu chẩn đoán";
        _translations["Security Alerts"] = "Cảnh báo bảo mật";
        _translations["System Info"] = "Thông tin hệ thống";
        _translations["Event Viewer"] = "Nhật ký sự kiện (Event Viewer)";
        _translations["Registry Editor"] = "Trình chỉnh sửa Registry";
        _translations["System Restore"] = "Khôi phục hệ thống";
        _translations["Task Manager"] = "Trình quản lý tác vụ";
        _translations["Windows Security"] = "Bảo mật Windows";
        _translations["Windows Update"] = "Cập nhật Windows";
        _translations["Safe (Recommended)"] = "An toàn (Khuyên dùng)";
        _translations["Max Performance"] = "Hiệu năng tối đa";
        _translations["Recommended (Auto-Tune)"] = "Khuyên dùng (Tự động)";
        _translations["Issues Found"] = "Lỗi được tìm thấy";
        _translations["Detected Inconsistencies"] = "Sự bất thường được phát hiện";
        _translations["Tweaks Applied"] = "Tinh chỉnh đã áp dụng";
        _translations["Restorable Hives"] = "Nhánh Registry có thể phục hồi";
        _translations["Safety Snapshots Created"] = "Bản chụp an toàn đã tạo";
        _translations["Kernel Engine Active"] = "Động cơ hệ thống đang hoạt động";
        _translations["Last Sync Time"] = "Thời gian đồng bộ gần nhất";
        _translations["Launch Module"] = "Mở mô-đun";
        _translations["Requires Admin Privileges"] = "Yêu cầu quyền Quản trị viên (Admin)";
        _translations["Repair Progress"] = "Tiến độ sửa chữa";
        _translations["Package Provider"] = "Nguồn cung cấp gói";
        _translations["Unapplied Only"] = "Chỉ mục chưa áp dụng";
        _translations["Scan Again"] = "Quét lại";
        _translations["Deeply scans storage drives to locate and wipe redundant junk files created by Windows OS, web browsers, and third-party applications during daily usage."] = "Quét sâu các ổ lưu trữ để tìm và xóa tệp rác dư thừa do Windows, trình duyệt web và ứng dụng bên thứ ba tạo ra trong quá trình sử dụng.";
        _translations["Diagnoses internet connection health, tests bandwidth speeds, and resolves network connectivity issues or latency spikes."] = "Chẩn đoán kết nối internet, kiểm tra tốc độ băng thông và khắc phục sự cố mất kết nối hoặc giật lag mạng.";
        _translations["Integrates advanced Windows diagnostic and repair utilities to automatically repair corrupt system files, component store corruption, and Windows Update errors."] = "Tích hợp các tiện ích chẩn đoán và sửa chữa nâng cao của Windows để tự động sửa tệp hệ thống bị hỏng, kho thành phần và lỗi Windows Update.";
        _translations["Protects personal privacy by purging activity histories, temporary clipboard data, and disabling Windows telemetry tracking."] = "Bảo vệ quyền riêng tư bằng cách xóa lịch sử hoạt động, dữ liệu bộ nhớ tạm và tắt theo dõi telemetry của Windows.";
        _translations["Provides real-time system monitoring for CPU, RAM, GPU, and Disk utilization, along with continuous Health Score tracking and one-click Quick Boost optimization."] = "Cung cấp khả năng giám sát thời gian thực CPU, RAM, GPU và Ổ đĩa, cùng tính năng theo dõi Điểm sức khỏe liên tục và tăng tốc nhanh 1-click.";
        _translations["Scans for invalid registry keys, orphaned file extensions, and broken installation entries while backing up HKLM and HKCU partitions for absolute safety."] = "Quét tìm các khóa registry không hợp lệ, phần mở rộng tệp mồ côi và bản ghi cài đặt bị hỏng, đồng thời sao lưu HKLM và HKCU để đảm bảo an toàn tuyệt đối.";
        _translations["Scans installed third-party applications for available security patches and software updates, enabling silent 1-click batch updates."] = "Quét các ứng dụng bên thứ ba đã cài đặt để tìm bản vá bảo mật và cập nhật phần mềm, cho phép cập nhật hàng loạt 1-click.";
        _translations["Create a lightweight system snapshot checkpoint before applying significant system tweaks or modifications."] = "Tạo điểm khôi phục hệ thống an toàn trước khi áp dụng các thay đổi hoặc tinh chỉnh lớn trên Windows.";
        _translations["WinCare Pro strictly adheres to official Microsoft APIs and Windows Service architectures. All operations create backups or restore points prior to execution."] = "WinCare Pro tuân thủ nghiêm ngặt các API chính thức của Microsoft và kiến trúc dịch vụ Windows. Mọi thao tác đều tạo bản sao lưu hoặc điểm khôi phục trước khi thực hiện.";
        _translations["Protects vital Windows services (WinDefend, RpcSs, EventLog, Dhcp) against accidental termination."] = "Bảo vệ các dịch vụ Windows trọng yếu (WinDefend, RpcSs, EventLog, Dhcp) khỏi việc bị tắt nhầm.";
        _translations["System working set and caches are fully refreshed. Disk performance and application response times are at peak efficiency."] = "Bộ nhớ làm việc và cache hệ thống đã được làm mới hoàn toàn. Hiệu suất ổ đĩa và tốc độ phản hồi ứng dụng đạt mức tối đa.";
        _translations["System tweaks, RAM working set optimization, and performance profiles."] = "Tinh chỉnh hệ thống, tối ưu bộ nhớ RAM và hồ sơ hiệu năng.";
        _translations["Registry backup, defragmentation, and cleanup."] = "Sao lưu, chống phân mảnh và dọn dẹp Registry.";
        _translations["Firewall Rules"] = "Quy tắc tường lửa";
        _translations["Inbound & outbound rules."] = "Quy tắc đến & đi.";
        _translations["Inbound &amp; outbound rules."] = "Quy tắc đến & đi.";
        _translations["Log typing history & input telemetry."] = "Ghi lại lịch sử gõ phím & dữ liệu nhập liệu.";
        _translations["Log typing history &amp; input telemetry."] = "Ghi lại lịch sử gõ phím & dữ liệu nhập liệu.";
        _translations["Send diagnostic data to Microsoft."] = "Gửi dữ liệu chẩn đoán về Microsoft.";
        _translations["Erase cached activity logs and history:"] = "Xóa nhật ký hoạt động và lịch sử đã lưu:";
        _translations["Wipe Clipboard"] = "Xóa bộ nhớ tạm (Clipboard)";
        _translations["Input & Typing Tracking"] = "Theo dõi nhập liệu & bàn phím";
        _translations["Input &amp; Typing Tracking"] = "Theo dõi nhập liệu & bàn phím";

        _translations["Click to Open WinCare Pro"] = "Nhấp để Mở WinCare Pro";
        _translations["Toggle Always On Top"] = "Bật/Tắt Ghim trên cùng";
        _translations["Collapse to Mini HUD"] = "Thu nhỏ thành Mini HUD";
        _translations["Expand to Full HUD"] = "Mở rộng Full HUD";
        _translations["Instant RAM Purge (Smart 1-Click Boost)"] = "Giải phóng RAM vật lý tức thì (Smart 1-Click Boost)";
        _translations["Fast RAM Boost (1-Click Boost)"] = "Tăng tốc RAM nhanh (1-Click Boost)";
        _translations["View all 14 module guides"] = "Xem tất cả 14 phân hệ hướng dẫn";
        _translations["System Care & Clean"] = "Chăm sóc & Dọn dẹp hệ thống";
        _translations["System Care &amp; Clean"] = "Chăm sóc & Dọn dẹp hệ thống";
        _translations["System & Performance Tuning"] = "Tối ưu hóa hiệu năng & Hệ thống";
        _translations["System &amp; Performance Tuning"] = "Tối ưu hóa hiệu năng & Hệ thống";
        _translations["Security, Privacy & Windows Repair"] = "Bảo mật, Quyền riêng tư & Sửa lỗi Windows";
        _translations["Security, Privacy &amp; Windows Repair"] = "Bảo mật, Quyền riêng tư & Sửa lỗi Windows";
        _translations["System Tools & Windows Management"] = "Công cụ hệ thống & Quản lý Windows";
        _translations["System Tools &amp; Windows Management"] = "Công cụ hệ thống & Quản lý Windows";
        _translations["Click to copy Public IP"] = "Nhấp để sao chép IP công khai";
        _translations["Copy Console Output"] = "Sao chép kết quả console";
        _translations["Copy Socket Info"] = "Sao chép thông tin Socket";
        _translations["Clear All"] = "Xóa tất cả";
        _translations["Clear All Alerts"] = "Xóa tất cả thông báo";
        _translations["Clear Recent Files & History"] = "Xóa tệp gần đây & Lịch sử";
        _translations["Clear Recent Files &amp; History"] = "Xóa tệp gần đây & Lịch sử";
        _translations["Clear Search & Show All"] = "Xóa tìm kiếm & Hiện tất cả";
        _translations["Clear Search &amp; Show All"] = "Xóa tìm kiếm & Hiện tất cả";
        _translations["Click 'AI Scan' to analyze system health."] = "Bấm 'Quét AI' để phân tích sức khỏe hệ thống.";
        _translations["Click 'Scan Directories' in the top header action bar to evaluate safe-to-clean junk files and system caching logs."] = "Bấm 'Quét thư mục' ở thanh tác vụ trên cùng để phát hiện các tệp rác và bộ nhớ đệm an toàn cần dọn dẹp.";
        _translations["Run AI Scan for insights"] = "Chạy quét AI để xem phân tích";
        _translations["DNS Server Latency Benchmark"] = "Đo độ trễ máy chủ DNS";
        _translations["Benchmark All DNS"] = "Đo tốc độ tất cả DNS";
        _translations["Active DNS:"] = "DNS đang dùng:";
        _translations["Apply DoH"] = "Áp dụng DoH";
        _translations["BUFFER JITTER"] = "ĐỘ BIẾN THIÊN JITTER";
        _translations["All Applications Up to Date"] = "Tất cả ứng dụng đã mới nhất";
        _translations["All Up-to-Date"] = "Tất cả đã mới nhất";
        _translations["Advertising ID"] = "ID Quảng cáo";
        _translations["App tracking & targeted ads."] = "Theo dõi ứng dụng & quảng cáo hướng đối tượng.";
        _translations["App tracking &amp; targeted ads."] = "Theo dõi ứng dụng & quảng cáo hướng đối tượng.";
        _translations["Audit events & system logs."] = "Nhật ký kiểm toán & sự kiện hệ thống.";
        _translations["Audit events &amp; system logs."] = "Nhật ký kiểm toán & sự kiện hệ thống.";
        _translations["Auto-purges RAM when load exceeds 85%"] = "Tự động giải phóng RAM khi vượt mức 85%";
        _translations["Background services control."] = "Quản lý dịch vụ chạy ngầm.";
        _translations["Cache copied items and credentials."] = "Lưu bộ đệm các mục đã sao chép và thông tin xác thực.";
        _translations["Cancel Operation"] = "Hủy thao tác";
        _translations["Clipboard History"] = "Lịch sử Clipboard";
        _translations["Clipboard Sanitizer • Recent Files Purge • Telemetry Shield"] = "Làm sạch Clipboard • Xóa tệp gần đây • Chống theo dõi telemetry";
        _translations["Bandwidth Speed Test • Flush DNS Cache • TCP Auto-Tuning"] = "Kiểm tra tốc độ băng thông • Xóa cache DNS • Tự động điều chỉnh TCP";
        _translations["Batch Uninstall • Leftover File & Registry Sweeper • Bloatware Removal"] = "Gỡ cài đặt hàng loạt • Dọn tệp & Registry tàn dư • Gỡ ứng dụng rác";
        _translations["Temp Cache • Browser Cache • Windows Update Debris • Memory Dumps"] = "Tệp tạm Cache • Cache trình duyệt • Rác Windows Update • Kết xuất bộ nhớ";
        _translations["CPU/RAM load & processes."] = "Tải CPU/RAM & tiến trình.";
        _translations["CPU/RAM load &amp; processes."] = "Tải CPU/RAM & tiến trình.";
        _translations["Ethernet/WiFi"] = "Mạng dây / WiFi";
        _translations["Hardware Trust"] = "Tin cậy phần cứng";
        _translations["Junk Sweeper Operation"] = "Tác vụ dọn dẹp rác";
        _translations["Junk:"] = "Tệp rác:";
        _translations["Just Now"] = "Vừa xong";
        _translations["Loading systems..."] = "Đang tải hệ thống...";
        _translations["Manage and clean Windows Explorer right-click shell extensions."] = "Quản lý và làm sạch tiện ích mở rộng chuột phải trong Windows Explorer.";
        _translations["Manages shortcuts and background shell extensions displayed in the Windows Explorer right-click Context Menu for cleaner, faster File Explorer operation."] = "Quản lý các lối tắt và tiện ích nền hiển thị trong Menu chuột phải Windows Explorer để File Explorer gọn gàng, nhanh hơn.";
        _translations["More Options"] = "Tùy chọn khác";
        _translations["Network monitoring, DNS benchmark, and latency diagnostics."] = "Giám sát mạng, đo tốc độ DNS và chẩn đoán độ trễ.";
        _translations["Occupied:"] = "Đã chiếm dụng:";
        _translations["Offers a compact floating desktop toolbar displaying live CPU/RAM usage meters, quick boost trigger, and system tray notification controls."] = "Cung cấp thanh công cụ nổi nhỏ gọn trên màn hình nền hiển thị tài nguyên CPU/RAM trực tiếp, nút tăng tốc nhanh và điều khiển khay hệ thống.";
        _translations["Optimize System"] = "Tối ưu hệ thống";
        _translations["Patches & security updates."] = "Bản vá & cập nhật bảo mật.";
        _translations["Patches &amp; security updates."] = "Bản vá & cập nhật bảo mật.";
        _translations["Processing Registry Operation..."] = "Đang xử lý tác vụ Registry...";
        _translations["Provider:"] = "Nguồn cung cấp:";
        _translations["Quick Tools:"] = "Công cụ nhanh:";
        _translations["RAM Maintenance"] = "Bảo trì RAM";
        _translations["Recent:"] = "Gần đây:";
        _translations["Smart Diagnostics"] = "Chẩn đoán thông minh";
        _translations["System configuration hives & keys."] = "Nhánh cấu hình & khóa hệ thống.";
        _translations["System configuration hives &amp; keys."] = "Nhánh cấu hình & khóa hệ thống.";
        _translations["System Purge & Clean Completed Successfully! 🚀"] = "Dọn dẹp hệ thống hoàn tất thành công! 🚀";
        _translations["System Purge &amp; Clean Completed Successfully! 🚀"] = "Dọn dẹp hệ thống hoàn tất thành công! 🚀";
        _translations["Telemetry & Privacy"] = "Telemetry & Quyền riêng tư";
        _translations["Telemetry &amp; Privacy"] = "Telemetry & Quyền riêng tư";
        _translations["Used:"] = "Đã dùng:";
        _translations["Active Link"] = "Liên kết hoạt động";
        _translations["Alerts:"] = "Cảnh báo:";
        _translations["services.msc — Configure Windows services startup types"] = "services.msc — Cấu hình kiểu khởi động dịch vụ Windows";
        _translations["taskmgr.exe — Monitor live service PIDs & RAM usage"] = "taskmgr.exe — Giám sát PID và bộ nhớ RAM tiến trình";
