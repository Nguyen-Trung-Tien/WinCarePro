# 🛡️ WinCare Pro Suite — Production System Rules & Engineering Gover> **Phiên bản áp dụng:** v4.9 Nova (Production Release)  
...
4. **Stability (Độ ổn định không crash):** Bọc an toàn 100% các cập nhật UI Thread, xử lý toàn diện ngoại lệ I/O và Win32, quản lý CancellationToken ngắt luồng chuẩn xác.
...
| **02** | [**02. Bảo Mật & An Toàn Tuyệt Đối**](02_SECURITY_AND_SAFETY_RULES.md) | Chống Command Injection (`ArgumentList`), SafePathGuard, SafeRegistryGuard, Service Safety Whitelist, WinTrust, DPAPI. | 🔴 **Bắt Buộc 100%** |
...
| **07** | [**07. Kiểm Thử Tự Động & Đảm Bảo QA**](07_TESTING_AND_QA_RULES.md) | Duy trì 100% Pass (300/300 Tests), In-Memory SQLite, Mock Win32 nguy hiểm, kiểm thử biên Edge Cases. | 🔴 **Bắt Buộc 100%** |
...
2. **Automated Test Suite:** Toàn bộ 300 bài kiểm thử xUnit trong `WinCarePro.Tests` phải hoàn thành `Passed 100%`.
